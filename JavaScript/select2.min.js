...
!function(e) {
    ...
    var e, n, i, d, r, o, p, h, f, g, m, y, s, a, v, i = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (u = t.fn.select2.amd),
    ...
    r = function(e, t, n, i) {
        ...
        "undefined" == u || "function" == u) {
            ...
            e && (s && s.exports !== d && s.exports !== f[e] ? f[e] = s.exports : u === d && l || (f[e] = u))
        } else
            e && (f[e] = n)
    }
    ,
    e = n = o = function(e, t, n, i, s) {
        if ("string" == typeof e)
            return h[e] ? h[e](t) : b(p(e, t).f);
        if (!e.splice) {
            if ((m = e).deps && o(m.deps, m.callback),
            !t)
                return;
            t.splice ? (e = t,
            t = n,
        ...
        i = s),
        i ? r(d, e, t, n) : setTimeout(function() {
            r(d, e, t, n)
        }, 4),
        o
    }
    ...
    u.define("select2/results", ["jquery", "./utils"], function(d, e) {
        ...
        i.prototype.option = function(e) {
            ...
            for (n in e.disabled && (delete i["aria-selected"],
        ...
        i.prototype.bind = function(t, e) {
            ...
            t.on("results:next", function() {
                ...
                0 === i ? s.$results.scrollTop(0) : t < n && s.$results.scrollTop(e))
            }),
            ...
            d.fn.mousewheel && this.$results.on("mousewheel", function(e) {
                ...
                t ? (s.$results.scrollTop(0),
                e.preventDefault(),
                e.stopPropagation()) : n && (s.$results.scrollTop(s.$results.get(0).scrollHeight - s.$results.height()),
                e.preventDefault(),
                e.stopPropagation())
            }),
        ...
        i.prototype.ensureHighlightVisible = function() {
            ...
            0 !== s.length && (e = this.$results.find("[aria-selected]").index(s),
    ...
    u.define("select2/selection/base", ["jquery", "../utils", "../keys"], function(n, e, s) {
        function i(e, t) {
            this.$element = e,
            this.options = t,
            i.__super__.constructor.call(this)
    ...
    u.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function(e, t, n, i) {
        ...
        s.prototype.update = function(e) {
            ...
            e = this.display(t, n),
            n.empty().append(e),
            n.prop("title", t.title || t.text)) : this.clear()
        }
        ,
        s
    }),
    u.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function(i, e, a) {
        ...
        s.prototype.bind = function(e, t) {
            ...
            this.$selection.on("click", ".select2-selection__choice__remove", function(e) {
                var t;
                n.options.get("disabled") || (t = i(this).parent().data("data"),
                n.trigger("unselect", {
                    originalEvent: e,
                    data: t
                }))
    ...
    u.define("select2/selection/allowClear", ["jquery", "../keys"], function(n, i) {
        ...
        e.prototype.update = function(e, t) {
            e.call(this, t),
            0 < this.$selection.find(".select2-selection__placeholder").length || 0 === t.length || ((e = n('<span class="select2-selection__clear">&times;</span>')).data("data", t),
    ...
    u.define("select2/selection/eventRelay", ["jquery"], function(o) {
        ...
        return e.prototype.bind = function(e, t, n) {
            ...
            t.on("*", function(e, t) {
                ...
                i.$element.trigger(n),
                -1 !== o.inArray(e, r) && (t.prevented = n.isDefaultPrevented()))
            })
        }
        ,
        e
    ...
    u.define("select2/data/select", ["./base", "../utils", "jquery"], function(e, t, o) {
        function n(e, t) {
            this.$element = e,
            this.options = t,
    ...
    u.define("select2/data/ajax", ["./array", "../utils", "jquery"], function(e, t, r) {
        ...
        n.prototype.query = function(t, n) {
            ...
            "function" == typeof s.url && (s.url = s.url.call(this.$element, t)),
            "function" == typeof s.data && (s.data = s.data.call(this.$element, t)),
    ...
    u.define("select2/data/tags", ["jquery"], function(a) {
        function e(e, t, n) {
            ...
            s = n.get("insertTag");
            if (s !== undefined && (this.insertTag = s),
            e.call(this, t, n),
            a.isArray(i))
        ...
        return e.prototype.query = function(e, l, c) {
            var u = this;
            this._removeOldTags(),
            null != l.term && null == l.page ? e.call(this, l, function d(e, t) {
                ...
                if (t)
                    return !0;
                var o, a = u.createTag(l);
                null != a && ((o = u.option(a)).attr("data-select2-tag", !0),
                u.addOptions([o]),
                u.insertTag(n, a)),
                e.results = n,
                c(e)
    ...
    u.define("select2/data/tokenizer", ["jquery"], function(c) {
        ...
        e.prototype.query = function(e, t, n) {
            ...
            var s = this.tokenizer(t, this.options, function(e) {
                ...
                }).length || ((t = i.option(n)).attr("data-select2-tag", !0),
                i._removeOldTags(),
                i.addOptions([t])),
                t = n,
                i.trigger("select", {
        ...
        e.prototype.tokenizer = function(e, t, n, i) {
            ...
            ; o < r.length; ) {
                var l = r[o];
                -1 !== c.inArray(l, s) ? (l = r.substr(0, o),
                null != (l = a(c.extend({}, t, {
                    term: l
                }))) ? (i(l),
                r = r.substr(o + 1) || "",
    ...
    u.define("select2/dropdown/infiniteScroll", ["jquery"], function(s) {
        function e(e, t, n, i) {
            this.lastParams = {},
            e.call(this, t, n, i),
        ...
        e.prototype.bind = function(e, t, n) {
            ...
            this.$results.on("scroll", function() {
                ...
                !i.loading && e && (e = i.$results.offset().top + i.$results.outerHeight(!1),
    ...
    u.define("select2/dropdown/attachBody", ["jquery", "../utils"], function(c, o) {
        function e(e, t, n) {
        ...
        e.prototype._positionDropdown = function() {
            ...
            ("above" == i || t && "below" !== i) && (l.top = r.top - s.top - o),
    ...
    u.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(p, h, f, g, m, y, v, _, $, w, b, t, A, x, E, C, O, S, T, D, q, L, j, P, k, I, R, M, e) {
        ...
        return n.prototype.apply = function(e) {
            var t, n;
            if (null == (e = p.extend(!0, {}, this.defaults, e)).dataAdapter && (null != e.ajax ? e.dataAdapter = E : null != e.data ? e.dataAdapter = x : e.dataAdapter = A,
            0 < e.minimumInputLength && (e.dataAdapter = w.Decorate(e.dataAdapter, S)),
            0 < e.maximumInputLength && (e.dataAdapter = w.Decorate(e.dataAdapter, T)),
            0 < e.maximumSelectionLength && (e.dataAdapter = w.Decorate(e.dataAdapter, D)),
            e.tags && (e.dataAdapter = w.Decorate(e.dataAdapter, C)),
            null == e.tokenSeparators && null == e.tokenizer || (e.dataAdapter = w.Decorate(e.dataAdapter, O)),
            null != e.query && (t = h(e.amdBase + "compat/query"),
            e.dataAdapter = w.Decorate(e.dataAdapter, t)),
            null != e.initSelection && (t = h(e.amdBase + "compat/initSelection"),
            e.dataAdapter = w.Decorate(e.dataAdapter, t))),
            null == e.resultsAdapter && (e.resultsAdapter = f,
            null != e.ajax && (e.resultsAdapter = w.Decorate(e.resultsAdapter, P)),
            null != e.placeholder && (e.resultsAdapter = w.Decorate(e.resultsAdapter, j)),
            e.selectOnClose && (e.resultsAdapter = w.Decorate(e.resultsAdapter, R))),
            null == e.dropdownAdapter && (e.multiple ? e.dropdownAdapter = q : (n = w.Decorate(q, L),
            e.dropdownAdapter = n),
            0 !== e.minimumResultsForSearch && (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, I)),
            e.closeOnSelect && (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, M)),
            null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass || (n = h(e.amdBase + "compat/dropdownCss"),
            e.dropdownAdapter = w.Decorate(e.dropdownAdapter, n)),
            e.dropdownAdapter = w.Decorate(e.dropdownAdapter, k)),
            null == e.selectionAdapter && (e.multiple ? e.selectionAdapter = m : e.selectionAdapter = g,
            null != e.placeholder && (e.selectionAdapter = w.Decorate(e.selectionAdapter, y)),
            e.allowClear && (e.selectionAdapter = w.Decorate(e.selectionAdapter, v)),
            e.multiple && (e.selectionAdapter = w.Decorate(e.selectionAdapter, _)),
            null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass || (l = h(e.amdBase + "compat/containerCss"),
            e.selectionAdapter = w.Decorate(e.selectionAdapter, l)),
            e.selectionAdapter = w.Decorate(e.selectionAdapter, $)),
            "string" == typeof e.language && (0 < e.language.indexOf("-") ? (c = e.language.split("-")[0],
            e.language = [e.language, c]) : e.language = [e.language]),
            p.isArray(e.language)) {
                var i = new b;
                e.language.push("en");
                for (var s = e.language, r = 0; r < s.length; r++) {
                    var o = s[r]
                      , a = {};
                    try {
                        a = b.loadPath(o)
            ...
            this.defaults = {
                ...
                matcher: function a(e, t) {
                    ...
                    if (t.children && 0 < t.children.length) {
                        for (var n = p.extend(!0, {}, t), i = t.children.length - 1; 0 <= i; i--)
                            null == a(e, t.children[i]) && n.children.splice(i, 1);
                        return 0 < n.children.length ? n : a(e, n)
                    }
                    var s = o(t.text).toUpperCase()
                      , r = o(e.term).toUpperCase();
                    return -1 < s.indexOf(r) ? t : null
                },
    ...
    u.define("select2/options", ["require", "jquery", "./defaults", "./utils"], function(n, r, i, o) {
        function e(e, t) {
            this.options = e,
            null != t && this.fromElement(t),
            this.options = i.apply(this.options),
            t && t.is("input") && (t = n(this.get("amdBase") + "compat/inputData"),
            this.options.dataAdapter = o.Decorate(this.options.dataAdapter, t))
        }
        return e.prototype.fromElement = function(e) {
            ...
            for (n in s = o._convertData(s))
                -1 < r.inArray(n, t) || (r.isPlainObject(this.options[n]) ? r.extend(this.options[n], s[n]) : this.options[n] = s[n]);
            return this
        }
        ,
    ...
    u.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(s, r, n, i) {
        var o = function(e, t) {
            null != e.data("select2") && e.data("select2").destroy(),
            this.$element = e,
            this.id = this._generateId(e),
            t = t || {},
            this.options = new r(t,e),
    ...
    u.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults"], function(s, e, r, t) {
        var o;
        return null == s.fn.select2 && (o = ["open", "close", "destroy"],
    ...
    function l(e, t) {
        var n, i, s, r, o, a, l, c, u, d, p = t && t.split("/"), h = m.map, f = h && h["*"] || {};
        if (e && "." === e.charAt(0))
            if (t) {

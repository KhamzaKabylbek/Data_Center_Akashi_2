!function(t, e, a) {
    "use strict";
    var n, i, s = t(e), r = t("body"), o = t("#slide-out-widget-area"), l = t("#slide-out-widget-area-bg"), d = t("#header-outer"), c = t("#header-secondary-outer"), h = t("#header-outer #search-btn a"), u = t("#wpadminbar"), p = t("#ajax-loading-screen"), f = t(".body-border-top"), g = t("#page-header-bg"), m = t("#footer-outer"), v = t(".body-border-right").length > 0 ? t(".body-border-right").width() : 0, b = d.is("[data-logo-height]") ? parseInt(d.attr("data-logo-height")) : 30, w = d.is("[data-padding]") ? parseInt(d.attr("data-padding")) : 28, y = d.is("[data-shrink-num]") ? d.attr("data-shrink-num") : 6, _ = !!d.is('[data-condense="true"]'), C = !!d.is('[data-using-logo="1"]'), x = !!d.is('[data-header-resize="1"]'), k = !!d.is('[data-transparent-header="true"]'), $ = (d.is('[data-mobile-fixed="1"]'),
    r.is("[data-header-format]") ? r.attr("data-header-format") : "default"), T = r.is("[data-hhun]") ? r.attr("data-hhun") : "", I = r.is("[data-cae]") && "swing" !== r.attr("data-cae") ? r.attr("data-cae") : "easeOutCubic", E = r.is("[data-cad]") ? r.attr("data-cad") : "650", O = t('body[data-animated-anchors="true"]').length > 0, z = !(r.is('[data-m-animate="1"]') || !navigator.userAgent.match(/(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/)), H = e.nectarOptions && e.nectarOptions.ocm_btn_position && "left" === e.nectarOptions.ocm_btn_position ? "left" : "default", S = [], A = [], M = [], W = [], B = [], F = [], q = [], L = [], j = [], Y = [], P = [], R = [], V = [], X = [], N = [], D = [], Q = [], Z = [], G = [], U = [], J = [], K = [], tt = [], et = [], at = [], nt = [], it = [], st = "", rt = !1, ot = !1, lt = {}, dt = {
        animating: "false",
        perspect: "not-rolled",
        inUse: !1
    }, ct = {
    ...
    f.length > 0 && ("#ffffff" == f.css("background-color") && "light" == r.attr("data-header-color") || "rgb(255, 255, 255)" == f.css("background-color") && "light" == r.attr("data-header-color") || f.css("background-color") == d.attr("data-user-set-bg")) && (ot = !0);
    var ht = {
        ...
        getWindowSize: function() {
            ht.winH = e.innerHeight,
            ht.winW = e.innerWidth,
            ht.adminBarHeight = u.length > 0 ? u.height() : 0,
            ht.secondaryHeaderHeight = c.length > 0 && "none" != c.css("display") ? c.outerHeight() : 0,
            ht.footerOuterHeight = m.length > 0 ? m.outerHeight() : 0
        },
        scrollTop: 0,
        clientX: 0,
        clientY: 0,
        ...
        scrollPosRAF: function() {
            ht.scrollTop = e.scrollY || s.scrollTop(),
            requestAnimationFrame(ht.scrollPosRAF)
        },
        bindEvents: function() {
            ht.usingMobileBrowser || (s.on("scroll", function() {
                ht.scrollTop = ht.scrollPosMouse()
            }),
            a.addEventListener("mousemove", function(t) {
                ht.clientX = t.clientX,
                ht.clientY = t.clientY
            })),
            s.on("resize", ht.getWindowSize),
            e.addEventListener("orientationchange", ht.getWindowSize)
        },
        init: function() {
            u = t("#wpadminbar"),
            this.getWindowSize(),
            this.usingPhoneBrowser = !!(ht.usingMobileBrowser && ht.winW < 690),
    ...
    function bt(t, e) {
        this.lastX = ht.clientX,
        this.lastY = ht.clientY,
        this.$el = t,
        this.iconType = e,
        this.timeout = !1,
        this.overEl = !1,
    ...
    function wt() {
        t('.wpb_gallery_slidesflickity_static_height_style .cell[data-lazy="true"]').each(function() {
            ...
            var e = parseInt(t(this).find("img").attr("height"))
              , a = Yt(parseInt(t(this).find("img").attr("width")), e, 2e3, parseInt(t(this).find("img").height()))
    ...
    function yt() {
        t('.wpb_gallery_slidesflickity_static_height_style .cell[data-lazy="true"]').length > 0 && (wt(),
        s.on("smartresize", wt))
    }
    function _t() {
        ...
        t(".nectar-flickity:not(.masonry)").each(function(e) {
            W.push(new Ct(t(this),e))
        }),
        t(".nectar-carousel.nectar-flickity:not(.masonry)").length > 0 && (ht.usingMobileBrowser ? e.addEventListener("orientationchange", xt) : s.on("resize", xt))
    }
    function Ct(t, e) {
        this.$el = t,
        this.index = e,
    ...
    function Tt() {
        t("nav:not(.left-side):not(.right-side) .sf-menu > .nectar-megamenu-menu-item.align-left:not(.width-100)").each(function() {
            ...
            if (e) {
                if (n.width() + e.offset().left > ht.winW)
    ...
    function Et() {
        ht.winW < 1e3 && "1" == r.attr("data-responsive") ? (r.addClass("mobile"),
    ...
    function Ot() {
        0 != t(".carousel").length && ("undefined" != typeof SalientRecentProjectsCarousel && t("ul.carousel.portfolio-items").each(function(e) {
            tt[e] = new SalientRecentProjectsCarousel(t(this))
        }),
        ...
        s.on("smartresize.carouselHeightCalcs", Mt))
    }
    function zt() {
    ...
    function At() {
        0 === t(".products-carousel").length && 0 === t(".nectar-woo-flickity").length || (t(".products-carousel").each(function(e) {
            new St(t(this),"legacy",e)
        }),
        N = [],
        t(".nectar-woo-flickity").each(function(e) {
            N.push(new St(t(this),"flickity",e))
        }))
    }
    function Mt() {
    ...
    function Wt() {
        ...
        s.off("smartresize.clientsCarouselHeight", Bt),
        s.on("smartresize.clientsCarouselHeight", Bt))
    }
    function Bt() {
        var e = 0;
    ...
    function Rt() {
        var e;
        if (r.is('[data-header-format="left-header"]') && ht.winW >= 1e3 || r.is('[data-hhun="1"]') || t(".page-template-template-no-header-footer").length > 0 || t(".page-template-template-no-header").length > 0)
            e = 0;
        else {
            var a = w - w / 1.8
              , n = d.outerHeight();
            (c.length > 0 && r.is(".material") || c.length > 0 && !r.is(".material") && ht.winW < 1e3) && (n -= ht.secondaryHeaderHeight),
            e = d.is('[data-header-resize="1"]') && !d.is(".small-nav") && ht.winW >= 1e3 ? n - (parseInt(y) + 2 * a) : n
        }
        if (ht.winW >= 1e3 && t('#header-outer[data-condense="true"]').length > 0) {
            var i = t('#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_9');
            e = d.height() - (parseInt(i.position().top) - parseInt(d.find("#logo").css("margin-top"))) - parseInt(ht.secondaryHeaderHeight)
        }
        return e
    }
    function Vt(t, e, n) {
    ...
    function Xt() {
        ht.usingMobileBrowser || (this.state = {
            ocmFocus: !1
        },
        this.init(),
        this.events())
    ...
    function Zt() {
        var e = t("body[data-header-breakpoint]").length > 0 && "1000" != r.attr("data-header-breakpoint") ? parseInt(r.attr("data-header-breakpoint")) : 1e3
          , a = !1;
        return 1e3 != e && ht.winW > 1e3 && ht.winW <= e && (a = !0),
        a
    }
    function Gt(t) {
    ...
    ,
    bt.prototype.viewportTracking = function() {
        var a = this;
    ...
    ,
    bt.prototype.createMarkup = function() {
        var e = this;
        if ("horizontal-movement" === this.iconType) {
            if (this.$el.is("[data-indicator-bg]") && (this.styleType = "solid"),
            0 == t(".nectar-drag-indicator").length) {
                var a = t("body > #boxed").length > 0 ? " in-boxed" : "";
                t("body").append('<div class="nectar-drag-indicator' + a + '" data-type="' + this.styleType + '"><div class="color-circle"></div><span class="inner-layer"><i class="fa fa-angle-left"></i><i class="fa fa-angle-right"></i></span></div>'),
        ...
        if ("view-indicator" === this.iconType || "link-indicator" === this.iconType) {
            ...
            0 == t(".nectar-view-indicator").length) {
                ...
                "gallery-zoom-indicator" !== this.iconType && t(".nectar-view-indicator span").text(t(".nectar-post-grid").attr("data-indicator-text")),
    ...
    ,
    bt.prototype.mouseBind = function() {
        var e = this;
        if ("horizontal-movement" === this.iconType)
            e.$el.find(".flickity-viewport").on("mouseover", function() {
            ...
            e.$el.find(".nectar-post-grid-item .meta-category a").on("mouseenter", function() {
                e.$viewEl.removeClass("visible")
            }),
            e.$el.find(".nectar-post-grid-item .meta-category a").on("mouseleave", function() {
                e.$viewEl.addClass("visible")
            })
        } else
    ...
    ,
    bt.prototype.updatePos = function() {
        this.lastY = jt(this.lastY, ht.clientY, this.lerpDamp),
        this.lastX = jt(this.lastX, ht.clientX, this.lerpDamp)
    }
    ,
    bt.prototype.parallaxIcon = function() {
        this.parallaxLastX = jt(this.parallaxLastX, parseInt(ht.clientX) - parseInt(this.lastX), this.lerpDamp) / 1.7,
        this.parallaxLastY = jt(this.parallaxLastY, parseInt(ht.clientY) - parseInt(this.lastY), this.lerpDamp) / 1.7,
        this.$innerParallaxEl.length > 0 && (this.$innerParallaxEl[0].style.transform = "translateX(" + Lt(this.parallaxLastX, 10, -10) + "px) translateY(" + Lt(this.parallaxLastY, 10, -10) + "px)")
    }
    ,
    bt.prototype.dragRAF = function() {
        this.updatePos(),
    ...
    ,
    bt.prototype.closeRAF = function() {
        this.updatePos(),
        this.$closeEl.css({
    ...
    Ct.prototype.setup = function() {
        ...
        if (this.$el.is('[data-format="fixed_text_content_fullwidth"]') && (this.$flickCellAlign = "left",
        ...
        !ht.usingFrontEndEditor && !function() {
            if (-1 != navigator.userAgent.indexOf("Instagram"))
                return !0;
            return !1
        }() && "IntersectionObserver"in e ? this.lazyInit() : this.init()
    }
    ,
    Ct.prototype.lazyInit = function() {
        var t = this;
        this.observer = new IntersectionObserver(function(e) {
            e.forEach(function(e) {
    ...
    Ct.prototype.init = function() {
        this.instance = new Flickity(".nectar-flickity.instance-" + this.index,{
            ...
            accessibility: !1,
            fade: this.fadeBool,
            dragThreshold: ht.usingMobileBrowser ? 25 : 3,
            arrowShape: this.$arrowShape
        }),
        this.events()
    }
    ,
    Ct.prototype.trackView = function() {
        var t = this;
    ...
    Ct.prototype.events = function() {
        ...
        this.$el.is('[data-format="fixed_text_content_fullwidth"]') && !ht.usingFrontEndEditor && this.fixedContentStyle(),
        ...
        .bind(this)),
        (this.$el.is('[data-pause-on-hover="true"]') || this.$nextPrevArrowBool || ht.usingFrontEndEditor) && this.$el[0].addEventListener("mouseenter", function() {
            this.tickerPaused = !0
        }
        .bind(this))),
        this.sharedEvents()
    ...
    ,
    Ct.prototype.sharedEvents = function() {
    ...
    ,
    Ct.prototype.tickerRotate = function() {
    ...
    ,
    Ct.prototype.imageCaptionWidth = function() {
    ...
    ,
    Ct.prototype.simpleSlideBGConnection = function() {
    ...
    ,
    Ct.prototype.simpleSliderStyle = function() {
        var e = this.$el
          , a = this;
    ...
    ,
    Ct.prototype.galleryParallax = function() {
    ...
    ,
    Ct.prototype.visualizedTotalControls = function() {
        var e = this.$el
        ...
        ht.usingMobileBrowser || (B[this.index] = new bt(this.$el,"horizontal-movement"),
        this.instance.on("dragMove", function(t, e) {
            ht.clientY = e.clientY,
            ht.clientX = e.clientX
        }),
    ...
    ,
    Ct.prototype.fixedContentStyle = function() {
        var a = ht.usingMobileBrowser
          , n = this.$el
          , i = this;
    ...
    ,
    St.prototype.setup = function() {
        !ht.usingFrontEndEditor && "IntersectionObserver"in e ? this.lazyInit() : this.init()
    }
    ,
    ...
    ,
    St.prototype.lazyInit = function() {
        var t = this;
        this.observer = new IntersectionObserver(function(e) {
            e.forEach(function(e) {
                e.isIntersecting && (t.init(),
    ...
    ,
    St.prototype.legacyCarousel = function() {
    ...
    ,
    St.prototype.flickityCarousel = function() {
        var a = this.$el;
        ...
        this.$el.is('[data-controls="touch_indicator"]'))
            ht.usingMobileBrowser || (B.push(new bt(this.$el,"horizontal-movement")),
    ...
    Xt.prototype.escCloseEvents = function() {
        t(a).on("keyup", function(e) {
            ...
            t(".nectar-slide-in-cart.style_slide_in_click.open").length > 0 && en(),
    ...
    t.cssHooks.color = {
        get: function(t) {
            ...
            -1 == n.search("rgb") ? n : (n = n.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/)) ? "#" + Nt(n[1]) + Nt(n[2]) + Nt(n[3]) : void 0
        }
    },
    ...
    function(t) {
        ...
        n.prototype.process = function() {
            if (pt.preventScroll)
                return !0;
            var e, a = ht.scrollTop + this.options.offset + this.pageSubmenuHeight, n = this.getScrollHeight(), i = this.options.offset + n - this.$scrollElement.height() - this.pageSubmenuHeight, s = this.offsets, r = this.targets, o = this.activeTarget;
    ...
    function ie() {
        t(st + " .wpb_animate_when_almost_visible").each(function() {
            var e = t(this)
              , a = 1 == rt ? "200%" : "90%"
              , n = new Waypoint({
                element: e[0],
    ...
    function re() {
        t(st + ".nectar-milestone").each(function() {
            var e = 1 == rt ? "250%" : "98%";
            ht.usingMobileBrowser && "98%" == e && (e = "110%");
            var a = 0;
    ...
    function le() {
        r.on("click", ".tabbed > ul li:not(.cta-button) a", function(a) {
            if (function(a) {
                ...
                c.find(".nectar-progress-bar").length > 0 && Ve(),
                (c.find('.divider-small-border [data-animate="yes"]').length > 0 || c.find('.divider-border [data-animate="yes"]').length > 0) && Qe(),
                (c.find("img.img-with-animation").length > 0 || c.find(".col.has-animation").length > 0 || c.find(".nectar_cascading_images").length > 0 || c.find(".wpb_column.has-animation").length > 0) && (je(),
                Ye()),
                (c.find(".parallax-layer").length > 0 || c.parents(".nectar-parallax-enabled").length > 0) && Me(),
                Oe(),
                c.find(".nectar-milestone").length > 0 && re(),
                c.find('.nectar_image_with_hotspots[data-animation="true"]').length > 0 && (Ue(),
                setTimeout(function() {
                    s.trigger("resize")
                }, 100)),
                c.find(".nectar-fancy-ul").length > 0 && _e(),
                c.find(".nectar-split-heading").length > 0 && Re(),
                c.find('.wpb_column[data-border-animation="true"]').length > 0 && Xe(),
                c.find(".wpb_animate_when_almost_visible").length > 0 && ie(),
                c.find(".nectar-animated-title").length > 0 && ra(),
                c.find(".nectar-highlighted-text").length > 0 && oa(),
                c.find(".nectar_food_menu_item").length > 0 && De(),
                c.find('.nectar-post-grid:not([data-animation="none"])').length > 0 && sa(),
                c.find(".nectar-waypoint-el").length > 0 && Ne(),
                ...
                c.find(".nectar-woo-flickity").length > 0 && "undefined" != typeof Flickity && (Flickity.data(a.parents(".tabbed").find("> div:nth-of-type(" + n + ")").find(".nectar-woo-flickity > ul")[0]).resize(),
                ...
                c.find(".svg-icon-holder").each(function(e) {
                    ...
                    setTimeout(function() {
                        ...
                        A[a.find("svg").attr("id").slice(-1)].finish()) : (A[a.find("svg").attr("id").slice(-1)].reset(),
                        K[e] = setTimeout(function() {
                            A[a.find("svg").attr("id").slice(-1)].play()
                        }, t))
                    }, 150)
                }),
                ...
                0,
                a.parent().parent().find(".magic-line").length > 0 && oe(a),
                t(e).trigger("nectar-tab-changed")
            }(t(this)),
            void 0 !== a.originalEvent && ht.winW < 1e3 && 0 == ct.$usingFullScreenRows) {
                var n = t(this).closest(".tabbed").find("> ul");
                if (n.height() > 350) {
                    var i = n.offset().top + n.height() - ht.adminBarHeight;
                    t('#header-outer[data-mobile-fixed="1"]').length > 0 && (i = n.offset().top + n.height() - d.outerHeight() - ht.adminBarHeight),
                    Qt(i, 700, "easeInOutQuint")
                }
            }
            return !1
        }),
        ...
        t(".tabbed").each(function() {
            ...
            setTimeout(function() {
                ...
                oe(e.find("> ul > li:first-child > a")))
            }, 100)
        }),
        t('.tabbed[data-style="minimal_alt"]').length > 0 && s.on("smartresize", function() {
            t('.tabbed[data-style="minimal_alt"]').each(function() {
                t(this).find("a.active-tab").length > 0 && oe(t(this).find("a.active-tab"))
            })
        }),
        void 0 !== Kt.tab && t(".wpb_tabs_nav").each(function() {
            t(this).find("li").each(function() {
                var e = t(this).find("a").clone()
                  , a = Kt.tab
                  , n = t(this);
        ...
        t(".nectar-scrolling-tabs").each(function(e) {
            ht.usingFrontEndEditor || (at[e] = new de(t(this)))
        });
        var a = !1;
    ...
    function ce() {
        void 0 !== Kt.toggle && t(".toggles").each(function() {
    ...
    function ue() {
        setTimeout(function() {
            t('.toggles.accordion:not([data-starting="closed"])').each(function() {
                ...
                else if (!ht.usingFrontEndEditor) {
        ...
        t('.toggle[data-inner-wrap="true"]').length > 0 && s.on("smartresize", he),
        ...
        t(".nectar-3d-transparent-button").each(function() {
            if ("visible" == t(this).css("visibility")) {
                ...
                if ("extra_jumbo" == e.attr("data-size")) {
                    var i;
                    ht.winW < 1e3 && ht.winW > 690 ? (a = 64,
                    i = 34,
                    e.find(".back-3d rect").attr("stroke-width", "12"),
                    n = 1.7) : ht.winW <= 690 ? (a = 46,
                    i = 16,
    ...
    function me() {
        if (ht.usingMobileBrowser || t('.nectar-cta[data-style="text-reveal-wave"], .menu-item-hover-text-reveal-wave').each(function() {
            t(this).find(".char").each(function(e) {
                t(this).css("animation-delay", .015 * e + "s")
            });
            var e = t(this).is('[data-using-bg="true"]') ? ".link_wrap" : ".link_text"
              , a = !1;
            t(this).is('[class*="border_thickness_"]') && !t(this).is('[class*="border_thickness_0px"]') && (e = ".link_wrap",
            a = !0),
    ...
    function ye() {
        if (t(".morphing-outline").length > 0) {
            ...
            ae(e, "morphing-outlines")
        }
    }
    function _e() {
        t(st + ".nectar-fancy-ul").each(function() {
    ...
    function ke() {
        ...
        !ht.usingMobileBrowser && t('body[data-boxed-style="1"]').length > 0 && t("#boxed").length > 0 && t("#boxed").length > 0 && t(".full-width-section[data-top-percent], .full-width-section[data-bottom-percent], .full-width-content[data-top-percent], .full-width-content[data-bottom-percent]").each(function() {
    ...
    function $e() {
        if (0 != t('.carousel-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), #boxed .full-width-content').length) {
            var e, a, n, i = ht.winW, r = t(".body-border-right").length > 0 && i > 1e3 ? 2 * parseInt(t(".body-border-right").width()) : 0, o = t(".container-wrap").length > 0 ? parseInt(t(".container-wrap").outerWidth()) : s.width(), l = t("body[data-ext-padding]").length > 0 ? 2 * parseInt(t("body").attr("data-ext-padding")) : 180;
            if (1 == t("#boxed").length)
                a = (parseInt(t(".container-wrap").width()) - parseInt(t(".main-content").width())) / 2 + 4;
            else {
                var d = t('body[data-ext-responsive="true"]').length > 0 && i >= 1e3 ? l : 0;
                e = o - r <= parseInt(t(".main-content").css("max-width")) ? parseInt(t(".main-content").css("max-width")) : o - r;
                var c = parseInt(t(".main-content").css("max-width"));
                t('body.single-post[data-ext-responsive="true"]').length > 0 && t(".container-wrap.no-sidebar").length > 0 && (c = t(".post-area").width(),
                d = 0),
                a = Math.ceil((e + d - c) / 2)
            }
            ...
            t('.carousel-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]:not(.fullwidth-constrained), #boxed .full-width-content').each(function() {
                var s = t('#header-outer[data-format="left-header"]').length > 0 && i >= 1e3 ? parseInt(t('#header-outer[data-format="left-header"]').width()) : 0
                  , r = t(".body-border-right").length > 0 && i > 1e3 ? 2 * parseInt(t(".body-border-right").width()) - 2 : 0;
                if (1 == t("#boxed").length)
                    n = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").width()) : parseInt(t(this).parents(".container").width()),
                    t('body.single-post[data-ext-responsive="true"]').length > 0 && t(".container-wrap.no-sidebar").length > 0 && t(this).parents(".post-area").length > 0 ? (c = t(".post-area").width(),
                    d = 0,
                    e = o - r,
                    a = Math.ceil((e + d - c) / 2)) : a = t(this).parents(".page-submenu").length > 0 ? (parseInt(t(".container-wrap").width()) - n) / 2 : (parseInt(t(".container-wrap").width()) - n) / 2 + 4;
                else {
                    if (t('body.single-post[data-ext-responsive="true"]').length > 0 && t(".container-wrap.no-sidebar").length > 0 && t(this).parents(".post-area").length > 0)
                        ...
                        var h = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").css("max-width")) : parseInt(t(this).parents(".container").css("max-width"));
                        o - r <= h && (e = h),
                        c = h,
                        d = t('body[data-ext-responsive="true"]').length > 0 && ht.winW >= 1e3 ? l : 0,
                        s > 0 && (d = t('body[data-ext-responsive="true"]').length > 0 && ht.winW >= 1e3 ? 120 : 0)
                    }
                    a = Math.ceil((e + d - c) / 2)
                }
                var u = 0;
                ...
                var p = 1 == t("#boxed").length ? n + parseInt(2 * a) : o - r + u;
                if (0 == t("#boxed").length && t(this).hasClass("portfolio-items") && t(this).is('[data-gutter*="px"]') && t(this).attr("data-gutter").length > 0 && "none" != t(this).attr("data-gutter") && (p = o > 1e3 ? o - r + 3 : o - r),
                t(this).parent().hasClass("default-style"))
                    n = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").width()) : parseInt(t(this).parents(".container").width()),
                    0 != t("#boxed").length ? p = 1 == t("#boxed").length ? n + parseInt(2 * a) : o + u : (p = 1 == t("#boxed").length ? n + parseInt(2 * a) : o - r - .025 * (o - r) + u,
                    e = o - r <= n ? n : o - r - .025 * (o - r),
                    a = Math.ceil((e - n) / 2));
                else if (t(this).parent().hasClass("spaced"))
                    if (n = 0 == t("#nectar_fullscreen_rows").length ? parseInt(t(".main-content").width()) : parseInt(t(this).parents(".container").width()),
                    0 != t("#boxed").length)
                        p = 1 == t("#boxed").length ? n + parseInt(2 * a) - .02 * o : o + u;
                    else {
                        p = 1 == t("#boxed").length ? n + parseInt(2 * a) : o - r - Math.ceil(.02 * (o - r)) + u;
                        var f = o - r <= n ? n : o - r - .02 * (o - r);
                        a = Math.ceil((f - n) / 2 + 2)
                    }
    ...
    function Ie(t) {
        ...
        !ht.usingMobileBrowser || 0 != this.persistOnMobile) {
            this.setType(),
            this.calculatePos(),
            this.trackView(),
            this.animate(),
    ...
    function Ae() {
        if (!(ht.usingMobileBrowser && t('body[data-remove-m-parallax="1"]').length > 0)) {
            R = [],
            t('.wpb_column[data-scroll-animation="true"], .nectar-el-parallax-scroll[data-scroll-animation="true"]').each(function(e) {
                imagesLoaded(t(this), function(a) {
                    t(a.elements[0]).is('[data-scroll-animation="true"]') && 0 == t("#nectar_fullscreen_rows").length && (R[e] = new Ie(t(a.elements[0])))
                })
            }),
            Me();
            var e = 0;
            t('.nectar-recent-posts-single_featured, [data-n-parallax-bg="true"], .wpb_row.parallax_section, #page-header-bg[data-parallax="1"] .page-header-bg-image-wrap, #page-header-bg[data-parallax="1"] .nectar-video-wrap, .parallax_slider_outer .nectar-slider-wrap').each(function() {
                t(this).is("[data-n-parallax-bg][data-parallax-speed]") ? (Y[e] = new Ee(t(this),".parallax-layer",Se(t(this).attr("data-parallax-speed")),"regular"),
                e++) : 0 == t(this).find('[data-parallax-speed="fixed"]').length && (t(this).hasClass("nectar-slider-wrap") ? Y[e] = new Ee(t(this),".video-wrap, .image-bg",.25,"nectar-slider") : t(this).hasClass("page-header-bg-image-wrap") ? Y[e] = new Ee(t(this),".page-header-bg-image",.25,"page-header") : t(this).hasClass("nectar-video-wrap") && t(this).parents("#page-header-bg").length > 0 ? Y[e] = new Ee(t(this),".nectar-video-bg",.25,"page-header") : Y[e] = new Ee(t(this),".row-bg.using-image",Se(t(this).find(".row-bg").attr("data-parallax-speed")),"regular"),
                e++),
    ...
    function Me() {
        ht.usingMobileBrowser && t('body[data-remove-m-parallax="1"]').length > 0 || t('.nectar-recent-posts-single_featured, [data-n-parallax-bg="true"], .wpb_row.parallax_section, #page-header-bg[data-parallax="1"] .page-header-bg-image-wrap, .parallax_slider_outer .nectar-slider-wrap .slide-bg-wrap').each(function() {
            var e;
            ...
            if (0 == t(this).find(".row-bg").length && t(this).find(".page-header-bg-image").length > 0)
                ...
                t(this).parents(".top-level").length > 0 && !ht.usingFrontEndEditor || e && !ht.usingFrontEndEditor ? t(this).find(".image-bg").css({
                ...
                0 == t(".wpb_row").length && t(this).parents('.nectar-slider-wrap[data-full-width="true"]').length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "1" == t(this).parents(".parallax_slider_outer").index() && (e = !0),
                t("#portfolio-extra").length > 0 && t(this).parents(".wpb_row").length > 0 && t(this).parents(".parallax_slider_outer").length > 0 && "0" == t(this).parents(".wpb_row").index() && (e = !0),
                t(this).parents(".top-level").length > 0 && !ht.usingFrontEndEditor || e && !ht.usingFrontEndEditor ? t(this).find(".video-wrap").css({
                    height: Math.ceil(.25 * t(this).parent().offset().top) + t(this).outerHeight(!0)
                }) : t(this).find(".video-wrap").css({
                    height: Math.ceil(.25 * ht.winH) + t(this).outerHeight(!0)
                });
                ...
                a.width(1280 * r),
                a.height(720 * r)
            } else if (t(this).is(".nectar-recent-posts-single_featured") && t(this).parents(".top-level").length > 0 && !ht.usingFrontEndEditor)
                ;
            else if (t(this).is(".nectar-simple-slider") && t(this).parents(".top-level").length > 0 && !ht.usingFrontEndEditor)
                ;
                ...
                ;
            else if (!t(this).hasClass("top-level") || ht.usingFrontEndEditor || t(this).find(".parallax-layer").length > 0) {
                var o = ".row-bg"
                ...
                t(this).find(o).css({
                    height: Math.ceil(ht.winH * Se(l)) + t(this).outerHeight(!0) + d
                })
            }
        })
    }
    function We() {
        ...
        t('.container-wrap .full-width-section, .container-wrap .full-width-content:not(.page-submenu .full-width-content):not(.blog-fullwidth-wrap), .row > .nectar-slider-wrap[data-full-width="true"], .wpb_wrapper > .nectar-slider-wrap[data-full-width="true"], .portfolio-items[data-col-num="elastic"]').each(function() {
            if (t(this).parents(".nectar-global-section.before-footer").length > 0)
                return !0;
    ...
    function Be() {
        ...
        t(".main-content > .row > " + e + " .full-width-content, #portfolio-extra > " + e + " .full-width-content, .woocommerce-tabs #tab-description > .full-width-content, .post-area.span_12 article .content-inner > .full-width-content").each(function() {
            if (t(this).find("> .span_12 > " + e + " .col").length > 1) {
                ...
                ht.winW < 1e3 && t(this).find("> .span_12 > " + e + " .col .wpb_row .col").css("min-height", "0px"),
                t(this).hasClass("vertically-align-columns") && ht.winW > 1e3 && !t(this).hasClass("vc_row-o-equal-height") && t(this).find("> .span_12 > " + e + " .col").each(function() {
                    n = t(this).find("> .vc_column-inner > .wpb_wrapper").length > 0 ? ".vc_column-inner" : ".column-inner-wrap > .column-inner",
    ...
    function Fe() {
        t(".wpb_row:has(.nectar-parallax-scene)").each(function(e) {
            ...
            Z[e] = t(this).find(".nectar-parallax-scene").parallax({
                scalarX: a,
                scalarY: a
            });
    ...
    function je() {
        var a = 1 == rt ? "500%" : "88%"
          , n = 1 == rt ? "500%" : "70%"
          , i = 1 == rt ? "500%" : "70%";
        t(st + ".img-with-animation").each(function(e) {
            var n = t(this)
        ...
        t(st + ".nectar_cascading_images").each(function() {
            var e = t(this)
            ...
            var i = new Waypoint({
                element: e[0],
                handler: function() {
                    e.parents(".wpb_tab").length > 0 && "hidden" == e.parents(".wpb_tab").css("visibility") || e.hasClass("animated-in") ? i.destroy() : ((!z || t('body[data-responsive="0"]').length > 0) && (e.find(".cascading-image").each(function(e) {
                        var n = t(this);
        ...
        t(st + '.col.has-animation:not([data-animation*="reveal"]), ' + st + '.wpb_column.has-animation:not([data-animation*="reveal"]), ' + st + ".nectar-fancy-box.has-animation").each(function(n) {
            var i = t(this)
              , s = a;
                    ...
                    if (i.parents(".wpb_tab").length > 0 && "hidden" == i.parents(".wpb_tab").css("visibility") || i.hasClass("animated-in"))
                        ...
                        if (!z || t('body[data-responsive="0"]').length > 0) {
                            ...
                            var a = i.attr("data-delay")
                              , s = E;
                            if (i.hasClass("mobile-disable-entrance-animation") && ht.winW < 1e3 && (s = 0,
                            o = 0,
                            a = 0),
                            "fade-in-from-left" == i.attr("data-animation") || "fade-in-from-right" == i.attr("data-animation"))
                                ...
                                "fade-in" == i.attr("data-animation") ? U[n] = setTimeout(function() {
                                    i.transition({
                                        opacity: 1
                                    }, s, r)
                                }, a) : "grow-in" == i.attr("data-animation") || "zoom-out" == i.attr("data-animation") ? U[n] = setTimeout(function() {
                                    i.transition({
                                        scale: 1,
                                        opacity: 1
                                    }, s, r)
                                }, a) : "flip-in" == i.attr("data-animation") ? U[n] = setTimeout(function() {
                                    i.transition({
                                        rotateY: "0",
                                        opacity: 1
                                    }, s, r)
                                }, a) : "flip-in-vertical" == i.attr("data-animation") ? U[n] = setTimeout(function() {
                                    i.transition({
                                        rotateX: "0",
                                        y: "0",
                                        opacity: 1
                                    }, s, r)
                                }, a) : "slight-twist" == i.attr("data-animation") && (U[n] = setTimeout(function() {
                                    J.push(anime({
                                        targets: i[0],
                                        rotateY: [20, 0],
                                        rotateZ: [-4, 0],
        ...
        t(st + '.wpb_column.has-animation[data-animation*="reveal"]').each(function() {
            var e = I;
                        ...
                        if (!z || t('body[data-responsive="0"]').length > 0) {
                            ...
                            "reveal-from-bottom" == n.attr("data-animation") || "reveal-from-top" == n.attr("data-animation") ? setTimeout(function() {
                                1 == i ? n.find("> .vc_column-inner").transition({
                                    y: 0
                                }, E, e) : n.find(".column-inner-wrap, .column-inner").transition({
                                    y: 0
                                }, E, e, function() {
    ...
    function Re() {
        t(st + ".nectar-split-heading").each(function(e) {
            var a = 1 == rt ? "500%" : "bottom-in-view";
            t(this)[0].hasAttribute("data-animation-offset") && 1 != rt && t(this).attr("data-animation-offset").length > 0 && (a = parseInt(t(this).attr("data-animation-offset")) + "%");
            var n = t(this)
                        ...
                        if (!z || t('body[data-responsive="0"]').length > 0)
                            setTimeout(function() {
                                if (n.is('[data-animation-type="line-reveal-by-space"]:not([data-text-effect*="letter-reveal"])')) {
                                    ...
                                    e = parseInt(E) < 1100 ? E : "1100",
                                    n.is('[data-m-rm-animation="true"]') && ht.winW < 1e3 ? n.find("> * > span .inner").css({
    ...
    function Ve() {
        var e = 1 == rt ? "500%" : "bottom-in-view"
          , a = t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 && ht.usingMobileBrowser ? ".nectar-progress-bar" : st + ".nectar-progress-bar";
        ht.usingMobileBrowser && "bottom-in-view" == e && (e = "70%"),
        t(a).each(function() {
            var a = t(this)
              , n = new Waypoint({
                element: a[0],
    ...
    function Xe() {
        var e = 1 == rt ? "500%" : "75%";
        t(st + '.wpb_column[data-border-animation="true"]').each(function() {
            var a = t(this)
              , n = new Waypoint({
                element: a[0],
                handler: function() {
    ...
    function Ne() {
        t(st + ".nectar-waypoint-el").each(function() {
    ...
    function De() {
        var e = 1 == rt ? "500%" : "80%";
        t(st + ".nectar_food_menu_item").parent().each(function() {
            var a = t(this)
              , n = new Waypoint({
                element: a[0],
                handler: function() {
    ...
    function Qe() {
        var e = 1 == rt ? "500%" : "bottom-in-view";
        t(st + '.divider-small-border[data-animate="yes"], ' + st + '.divider-border[data-animate="yes"]').each(function() {
        ...
        t(".nectar_image_with_hotspots").each(function() {
            t(this).find(".nectar_hotspot_wrap").each(function() {
                if (ht.winW > 690) {
                    ...
                    e.left < 0 ? t(this).find(".nttip").addClass("force-right") : e.left + t(this).find(".nttip").outerWidth(!0) > ht.winW ? t(this).find(".nttip").addClass("force-left").css("width", "250px") : e.top + t(this).find(".nttip").height() + 35 > s.height() && t("#nectar_fullscreen_rows").length > 0 && t(this).find(".nttip").addClass("force-top"),
                    ...
                    0 == t(this).find(".nttip a.tipclose").length && t(this).find(".nttip .inner").append('<a href="#" class="tipclose"><span></span></a>'),
    ...
    function Ge() {
        ...
        r.on("click", ".nectar_hotspot.click", function() {
            ...
            return ht.winW <= 690 && (t("body.nectar_box_roll").length > 0 && t(".container-wrap").addClass("hotspot-open"),
    ...
    function Ue() {
        var e = 1 == rt ? "500%" : "50%";
        t(st + '.nectar_image_with_hotspots[data-animation="true"]').each(function() {
            var a = t(this)
              , n = new Waypoint({
                element: a[0],
                handler: function() {
    ...
    function Ke(a, n, i) {
        if (a.classList.contains("nectar-lazy")) {
            a.addEventListener("load", function() {
                ...
                ht.usingMobileBrowser || Waypoint.refreshAll(),
                i.unobserve(a)
            }),
            a.src = n;
    ...
    function ta() {
        ...
        if ("IntersectionObserver"in e) {
            s.off("resize.nectarLazySizing", ea),
            s.on("resize.nectarLazySizing", ea),
            lt = new IntersectionObserver(function(t) {
    ...
    function ea() {
        t("img.nectar-lazy:not(.loaded):not(.image-gallery-portfolio-item)").each(function() {
            if (t(this).hasClass("attachment-shop_thumbnail") || t(this).hasClass("attachment-woocommerce_thumbnail"))
                return !0;
            t(this).css({
                height: "",
                width: ""
    ...
    function aa() {
        F = [],
        j = [],
        ht.usingMobileBrowser || (t('.nectar-post-grid[data-indicator="yes"]').each(function(e) {
            F[e] = new bt(t(this),"view-indicator")
        }),
        t('.nectar-post-grid-wrap[data-style="mouse_follow_image"] .nectar-post-grid').each(function(e) {
            j[e] = new bt(t(this),"post-grid-images")
        }),
    ...
    function sa() {
        var e = 1 == rt ? "200%" : "75%";
        t(st + ".nectar-post-grid-wrap").each(function() {
            var a = t(this)
              , n = new Waypoint({
                element: a[0],
                handler: function() {
                    a.parents(".wpb_tab").length > 0 && "hidden" == a.parents(".wpb_tab").css("visibility") || a.hasClass("completed") ? n.destroy() : (a.find(".nectar-post-grid-filters").addClass("animated-in"),
                    a.find(".nectar-post-grid-item").each(function(e) {
                        var a = t(this);
                        setTimeout(function() {
                            a.addClass("animated-in")
                        }, 90 * e)
    ...
    function ra() {
        var e = 1 == rt ? "500%" : "bottom-in-view";
        t(st + ".nectar-animated-title").each(function() {
            var a = t(this)
              , n = new Waypoint({
                element: a[0],
                handler: function() {
    ...
    function oa() {
        var e = 1 == rt ? "500%" : "bottom-in-view";
        ht.usingMobileBrowser && "bottom-in-view" == e && (e = "85%"),
        t(st + ".nectar-highlighted-text").each(function(a) {
            var n = 0;
            ...
            z && t(this).find("em").addClass("animated"),
    ...
    function la() {
        var e = 1 == rt ? "500%" : "75%";
        t(st + '.nectar-woo-flickity[data-animation*="fade-in"]').each(function() {
            var a = t(this)
              , n = new Waypoint({
                element: a[0],
                handler: function() {
    ...
    function ca() {
        ...
        "undefined" != typeof NectarTestimonialSlider ? t(".testimonial_slider").each(function(e) {
            ...
            Q[e] = new NectarTestimonialSlider(a,n,ya,Be),
            t(this).is('.disable-height-animation:not([data-style*="multiple_visible"])') && (Q[e].testimonialSliderHeight(),
            setTimeout(Q[e].testimonialSliderHeight.bind(Q[e]), 700)),
            t(this).is('.testimonial_slider[data-style="multiple_visible_minimal"]') && Q[e].testimonialSliderHeightMinimalMult()
        }) : Vt("#nectar-testimonial-sliders-js", 0, ca)
    }
    function ha() {
        s.off("smartresize.nectarTestimonials"),
        s.off("resize.nectarTestimonialsMin"),
        Q.length > 0 && s.on("smartresize.nectarTestimonials", ua),
        t('.testimonial_slider[data-style="multiple_visible_minimal"]').length > 0 && s.on("resize.nectarTestimonialsMin", pa)
    }
    function ua() {
        for (var t = 0; t < Q.length; t++)
            Q[t].testimonialSliderHeight(),
            Q[t].testimonialHeightResize()
    }
    function pa() {
        for (var t = 0; t < Q.length; t++)
            Q[t].testimonialSliderHeightMinimalMult()
    }
    function fa(e) {
    ...
    function va() {
        t("iframe").each(function() {
            if (void 0 !== t(this).attr("src") && !t(this).hasClass("skip-nectar-video-size") && !t(this).hasClass("iframe-embed") && !t(this).hasClass("elementor-video-iframe") && 0 == t(this).parents(".ult_modal").length && 0 == t(this).parents(".ls-slide").length && 0 == t(this).parents(".woo-variation-product-gallery").length && 0 == t(this).parents(".esg-entry-media").length && 0 == t(this).parents(".wpb_video_widget.wpb_content_element").length) {
        ...
        t(".nectar-video-wrap").each(function() {
            ...
            if (0 != t(this).find("video").length) {
                if (t(this).parents("#page-header-bg").length > 0) {
                    ...
                    a = s.outerHeight(),
                    n = t(this).parents(".full-width-section").length > 0 ? ht.winW : s.outerWidth()
                }
                t(this).width(n),
    ...
    function _a() {
                ...
                if (0 != t(this).find("video").length) {
                    ...
                    if (0 === t(this).find("video.nectar-lazy-video").length)
                        var n = setInterval(function() {
                            a.find("video").get(0).readyState > 3 && (ht.usingMobileBrowser || (a.transition({
                                opacity: "1"
                            }, 400),
                    ...
                    ht.usingMobileBrowser && (a.parents(".full-width-section").length > 0 && 0 == a.parents("#nectar_fullscreen_rows").length && !a.hasClass("column-video") ? a.css("left", "50%") : a.css("left", "0px"),
                    1 == e && Xa(),
        ...
        ht.usingMobileBrowser && t(".nectar-video-wrap").each(function() {
        ...
        t(".vc_row").each(function() {
            ...
            ht.usingMobileBrowser || n.find(".nectar-video-wrap, .nectar-youtube-bg").css({
                opacity: "1",
                width: "100%",
                height: "100%"
            }),
    ...
    function Ca() {
        ...
        r.hasClass("single-post") && t(".nectar-social.vertical").length > 0) {
            ...
            new Waypoint({
                ...
                handler: function(t) {
                    pt.materialOffCanvasOpen || ("down" === t ? e.addClass("visible") : e.removeClass("visible"))
                },
                offset: "70%"
            })
        }
    ...
    function xa() {
        if (t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0 && ($a(),
        u.length > 0)) {
            var a = u.detach();
        ...
        function() {
            if (t('body.material[data-header-search="true"]').length > 0 || t("body.material .ocm-effect-wrap").length > 0) {
                var a, n = !1, i = 0, r = ht.winW, o = ht.winH;
                e.addEventListener("orientationchange", function() {
                    i = 1
                }),
                s.on("resize", function() {
                    ht.usingMobileBrowser ? (s.width() != r && s.height != o || 1 === i) && (r = ht.winW,
                    o = ht.winH,
                    i = 0,
                    n = !0) : n = !0,
                    n && (clearTimeout(a),
    ...
    function Ea() {
        e.nectarOptions && e.nectarOptions.ocm_remove_ext_menu_items && "remove_images" == e.nectarOptions.ocm_remove_ext_menu_items && !1 === pt.ocmInit && (t('.off-canvas-menu-container .title[class*="inherit-h"], #mobile-menu .title[class*="inherit-h"]').removeClass(function(t, e) {
    ...
    function Oa() {
        ht.winW < 1e3 || t("body > #boxed").length > 0 || t(".ocm-effect-wrap-inner > #boxed").length > 0 ? (t("#slide-out-widget-area.fullscreen .off-canvas-social-links, #slide-out-widget-area.fullscreen-alt .off-canvas-social-links").appendTo("#slide-out-widget-area .inner"),
    ...
    function za() {
        if (ka(),
        ht.usingMobileBrowser && t("#slide-out-widget-area.open").length > 0)
            return Sa(),
            !1;
        ht.usingMobileBrowser && (t(".slide-out-widget-area-toggle a").attr("aria-expanded", "true"),
        l.css({
            height: "100%",
            width: "100%"
        })),
        ...
        if (t("header#top .container .span_9 > .slide-out-widget-area-toggle").length > 0) {
            var i, c = t(".slide-out-hover-icon-effect"), h = ht.secondaryHeaderHeight, u = Zt();
            if (t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 && (u = !1),
            t("body.mobile").length > 0 || u || "left" === H)
                c.css({
                    top: t("header#top .span_9 > .slide-out-widget-area-toggle a").offset().top - ht.scrollTop
                }),
                "left" === n || "left" === H ? c.css({
                ...
                c.css({
                    top: ht.adminBarHeight + h + parseInt(t("header#top nav >ul .slide-out-widget-area-toggle a").css("padding-top")),
                    right: 29 + p
                })
            } else
                ...
                c.css({
                    top: parseInt(i.top) - ht.scrollTop,
                ...
                c.css({
                    top: ht.adminBarHeight + h + parseInt(i.top),
                    right: parseInt(t("#header-outer header >.container").css("padding-right")) + 2,
                    left: ""
                }))
        }
        if (t(".slide-out-hover-icon-effect .lines-button").removeClass("no-delay").addClass("unhidden-line"),
        0 == t('#header-outer[data-permanent-transparent="1"]').length && 0 == t("#nectar_fullscreen_rows").length && !ht.usingFrontEndEditor && ht.winW > 1e3 && (0 == ht.scrollTop && t("#header-outer.transparent").length > 0 || 0 == t("body.mobile").length && ot && (d.attr("data-transparent", "true").addClass("no-bg-color").addClass("slide-out-hover"),
        t("#header-outer header, #header-outer > .cart-outer").addClass("all-hidden")),
        0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && ot && (1 == x ? (s.off("scroll", hn),
        s.off("scroll", cn)) : (s.off("scroll", un),
        s.off("scroll", pn)))),
        ht.usingMobileBrowser)
            return !1;
        s.on("mousemove.rightOffsetCheck", Ha)
    }
    function Ha(a) {
        var n = s.width()
          , i = o.outerWidth()
          , r = Zt();
        ht.winW < 1e3 && (r = !0);
        ("left" !== (e.nectarOptions && e.nectarOptions.mobile_header_format && "centered-menu" === e.nectarOptions.mobile_header_format && r ? "left" : "right") && "left" !== H ? a.clientX < n - parseInt(i) - v : a.clientX > parseInt(i) + v) && o.hasClass("mouse-accessed") && (o.removeClass("mouse-accessed"),
        s.off("mousemove.rightOffsetCheck", Ha),
        o.css({
            transform: ""
        }).removeClass("open"),
        ...
        0 == t('#header-outer[data-permanent-transparent="1"]').length && (0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && ot && 0 == t("body.mobile").length && (d.removeClass("no-bg-color"),
        t("#header-outer header, #header-outer > .cart-outer").removeClass("all-hidden")),
        0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("body.mobile").length && ot && (1 == x ? (s.off("scroll.headerResizeEffect"),
        0 == ht.scrollTop ? (s.on("scroll.headerResizeEffect", cn),
        t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == ot && t("#header-outer.pseudo-data-transparent").length > 0 && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
            padding: "0"
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        })) : s.on("scroll.headerResizeEffect", hn)) : (s.off("scroll.headerResizeEffectOpaque"),
        s.on("scroll.headerResizeEffectOpaque", un)))))
    }
    function Sa() {
        ht.usingMobileBrowser && (t(".slide-out-widget-area-toggle a").attr("aria-expanded", "false"),
        l.css({
            height: "1px",
            width: "1px"
        })),
    ...
    function Ba() {
        ...
        r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a.closed:not(.animating), .nectar-ocm-trigger-open", function() {
            if (pt.ocmAnimating || "true" == dt.animating || t(".slide-out-from-right-hover").length > 0)
                return !1;
            var a, n = 700;
            return pt.ocmOpen = !0,
            Ea(),
            d.removeClass("no-transition"),
            t(this).hasClass("simple-mobile-menu") ? (Ma("simple-mobile-menu"),
            ...
            !1) : (o.hasClass("slide-out-from-right") ? function() {
                ...
                if (0 == t("body.material").length) {
                    ...
                    0 == t("#boxed").length) {
                        ...
                        0 == t('#header-outer[data-format="centered-logo-between-menu"]').length || h ? 0 == t('#header-outer[data-transparency-option="1"]').length || t('#header-outer[data-transparency-option="1"]').length > 0 && 0 == t('#header-outer[data-full-width="true"]').length || t("body.mobile").length > 0 ? d.stop(!0).css("transform", "translateY(0)").transition({
                            x: "left" === i || "left" === H ? 300 + a + "px" : "-" + (300 + a) + "px"
                    ...
                    0 == t('#header-outer[data-format="centered-logo-between-menu"]').length && 0 == v && ("left" === H || t("header#top #logo").stop(!0).transition({
                        x: 300 + a + "px"
                    }, 700, "easeInOutCubic")),
                    ...
                    0 == t('#header-outer[data-remove-fixed="1"]').length && ht.winW > 1e3 && (1 == ot && 1 == x && "true" == d.attr("data-transparent-header") ? (d.stop(!0).transition({
                        y: "0"
                    }, 0).addClass("transparent").css("transition", "transform"),
                    s.off("scroll", hn),
                    s.off("scroll", cn)) : 1 == ot && "true" == d.attr("data-transparent-header") && (d.addClass("transparent"),
                    s.off("scroll", un),
                    s.off("scroll", pn)))
                } else
                    t("body.material").length > 0 && (p.length > 0 && t(".ocm-effect-wrap #ajax-loading-screen").length > 0 && p.insertBefore(".ocm-effect-wrap"),
                    ht.scrollTop > 40 && t('body[data-hhun="1"] #header-secondary-outer').addClass("hidden"),
                    setTimeout(function() {
                        t(".slide-out-widget-area-toggle:not(.std-menu) > div > a").removeClass("animating")
                    }, 300),
                    t("#slide-out-widget-area, #slide-out-widget-area-bg, #header-outer .slide-out-widget-area-toggle").addClass("material-open"),
                    t('body:not(.mobile) #header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && "none" != t('#header-outer[data-format="centered-menu-bottom-bar"] .span_9').css("display") && (t("#header-outer:not(.fixed-menu)").css("top", ht.adminBarHeight - ht.scrollTop + "px"),
                    ...
                    t('body[data-hhun="1"]:not(.no-scroll):not(.mobile) #header-outer[data-permanent-transparent="false"]:not(.detached):not(.parallax-contained):not(.at-top-before-box)').css({
                        transition: "none",
                        transform: "translateY(" + ht.adminBarHeight + "px)"
                    }),
                    setTimeout(function() {
                ...
                var e = 0
                  , a = 0;
                ht.scrollTop + s.height() > t(".blurred-wrap").height() && 0 == t("#nectar_fullscreen_rows").length && (t("body,html").stop().animate({
                ...
                var n = d.offset().top - ht.scrollTop + ht.secondaryHeaderHeight;
                ...
                d.stop(!0).css("transform", "translateY(0)"),
                s.width() > 1e3 && 0 == t('#header-outer[data-format="centered-menu-bottom-bar"].fixed-menu').length && 0 == t('body.material #header-outer[data-condense="true"]').length && "true" == d.attr("data-transparent-header") && !ht.usingFrontEndEditor && (t("#logo .starting-logo").length > 0 || t("#logo.no-image").length > 0) && d.stop(!0).css("transform", "translateY(0)").addClass("transparent"),
                ...
                ".fullscreen-alt" === e) {
                    var n = d.offset().top - ht.scrollTop + ht.secondaryHeaderHeight;
                    t("#slide-out-widget-area" + e + " .inner-wrap").css("padding-top", d.outerHeight() + n)
                } else
                    t("#slide-out-widget-area" + e + " .inner-wrap").css("padding-top", d.outerHeight())
            }() : o.hasClass("fullscreen-inline-images") ? (a = ht.winW < ht.winH,
            d.css({
                "z-index": "9990",
            ...
            setTimeout(function() {
                ...
                k || (d.attr("data-transparent-header", "true"),
                0 === t("#logo .starting-logo:not(.dark-version)").length && d.addClass("lighten-logo")),
                ht.usingFrontEndEditor || d.stop(!0).css("transform", "translateY(0)").addClass("transparent"),
            ...
            t('.mobile #header-outer[data-permanent-transparent="false"]').length > 0 && t(".container-wrap").hasClass("no-scroll") && t("#ajax-content-wrap").addClass("at-content"),
            t("#slide-out-widget-area.fullscreen-inline-images .inner-wrap").css("padding-top", d.outerHeight()),
            n = 1100) : t("#header-outer #mobile-menu").length > 0 && Ma("slide-out-widget-area-toggle"),
            pt.ocmAnimating = !0,
            setTimeout(function() {
                pt.ocmAnimating = !1
            }, n),
            ...
            t('#header-outer[data-transparency-option="1"]').length > 0 && 0 == t("#boxed").length && t('#header-outer[data-full-width="true"]').length > 0 && !ht.usingFrontEndEditor && 0 == t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length && 0 == t('body.material #header-outer[data-condense="true"]').length && d.addClass("transparent"),
        ...
        r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a.open:not(.animating), .nectar-ocm-trigger-open a.open, #slide-out-widget-area .slide_out_area_close, > .slide_out_area_close, #slide-out-widget-area-bg.slide-out-from-right, .material-ocm-open #ajax-content-wrap", function(a) {
            ...
            if (null != a.originalEvent || 0 != t(".slide_out_area_close.non-human-allowed").length || 0 != t(".slide-out-widget-area-toggle.mobile-icon a.non-human-allowed").length)
                return !(pt.ocmAnimating || t(".slide-out-widget-area-toggle:not(.std-menu) a.animating").length > 0) && (pt.ocmOpen = !1,
                d.removeClass("no-transition"),
                t(this).parents(".simple-mobile-menu").length > 0 ? (Wa("simple-mobile-menu"),
                ...
                o.hasClass("slide-out-from-right") ? function() {
                    if (0 == t("body.material").length) {
                        ...
                        l.stop(!0).transition({
                            ...
                            0 == t('#header-outer[data-remove-fixed="1"]').length && (d.hasClass("parallax-contained") && ht.scrollTop > 0 && 0 == t('#header-outer[data-permanent-transparent="1"]').length ? d.removeClass("parallax-contained").addClass("detached").removeClass("transparent") : (0 == ht.scrollTop && t('body[data-hhun="1"]').length > 0 && t('#page-header-bg[data-parallax="1"]').length > 0 || 0 == ht.scrollTop && t('body[data-hhun="1"]').length > 0 && t(".parallax_slider_outer").length > 0) && t('#header-outer[data-transparency-option="1"]').length > 0 && d.addClass("transparent")),
                            t(".container-wrap").css("transform", "none")
                        }),
                        d.removeClass("style-slide-out-from-right"),
                        0 == t('#header-outer[data-remove-fixed="1"]').length && (1 == ot && 1 == x && ht.winW > 1e3 ? (s.off("scroll.headerResizeEffect"),
                        0 == ht.scrollTop ? (s.on("scroll.headerResizeEffect", cn),
                        t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == ot && t("#header-outer.pseudo-data-transparent").length > 0 && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
                            padding: "0"
                        }, {
                            ...
                            duration: 250,
                            easing: "easeOutCubic"
                        })) : s.on("scroll.headerResizeEffect", hn),
                        ...
                        d.css("transition", "transform")) : 1 == ot && ht.winW > 1e3 && (s.off("scroll.headerResizeEffectOpaque"),
                        s.on("scroll.headerResizeEffectOpaque", un),
                ...
                setTimeout(function() {
                    0 == t(".nectar-social.fixed").length && Ln(),
                ...
                setTimeout(function() {
                    ...
                    d.hasClass("pseudo-data-transparent") && d.attr("data-transparent-header", "false").removeClass("pseudo-data-transparent").removeClass("transparent")
                }, ".fullscreen-inline-images" == n ? 0 : 100)) : t("#header-outer #mobile-menu").length > 0 && Wa("slide-out-widget-area-toggle"),
        ...
        o.hasClass("fullscreen-inline-images")) {
            ...
            t(".off-canvas-menu-container .menu > .menu-item-has-children > a").on("click", function(e) {
                var a = Fa(t(this).parent().attr("class"));
    ...
    function qa() {
        t("#slide-out-widget-area.slide-out-from-right-hover").length > 0 ? function() {
            if (0 == t("#ajax-content-wrap > .slide-out-widget-area-toggle").length) {
                var e = t('.slide-out-widget-area-toggle[data-custom-color="true"]').length > 0 ? "#slide-out-widget-area > div" : "#slide-out-widget-area";
                t('<div class="slide-out-widget-area-toggle slide-out-hover-icon-effect" data-icon-animation="simple-transform"><div> <a href="#sidewidgetarea" class="closed"> <span> <span class="screen-reader-text">' + nectar_front_i18n.menu + '</span> <i class="lines-button x2"> <i class="lines"></i> </i> </span> </a> </div> </div>').insertAfter(e),
            ...
            ht.usingMobileBrowser ? (r.on("click", ".slide-out-widget-area-toggle:not(.std-menu) a", za),
            r.on("click", "#slide-out-widget-area-bg", Aa)) : (r.on("mouseenter", "#header-outer .slide-out-widget-area-toggle:not(.std-menu) a", za),
        ...
        s.on("smartresize", function() {
            (ht.winW > 1e3 && t(".slide-out-widget-area-toggle.mobile-icon a.open").length > 0 || ht.winW > 1e3 && t(".nectar-ocm-trigger-open.simple-mobile-menu a.open").length > 0) && (t(".slide-out-widget-area-toggle.mobile-icon a, .nectar-ocm-trigger-open.simple-mobile-menu a").addClass("non-human-allowed"),
        ...
        0 == t("#slide-out-widget-area.fullscreen-split").length && 0 == t('body.material[data-slide-out-widget-area-style*="slide-out-from-right"]').length && 0 == t('#slide-out-widget-area[data-dropdown-func="separate-dropdown-parent-link"]').length ? function() {
            ...
            "#" != t(this).attr("href") && La(t(this).parent())
        }),
    ...
    se.prototype.setup = function() {
        ...
        ht.usingMobileBrowser ? e.addEventListener("orientationchange", this.calcWidth.bind(this)) : t(e).on("resize", this.calcWidth.bind(this))
    }
    ,
    se.prototype.viewportTracking = function() {
        var t = this;
        if ("IntersectionObserver"in e) {
            this.observer = new IntersectionObserver(function(e) {
                e.forEach(function(e) {
    ...
    ,
    se.prototype.calcWidth = function() {
        var t = this
    ...
    ,
    se.prototype.sequence = function() {
    ...
    ,
    se.prototype.staggerWaypoint = function() {
        var e = this;
        if (1 == rt && 0 == this.$el.parents(".active").length)
            return !0;
    ...
    ,
    de.prototype.setVertCenter = function() {
        var t = (ht.winH - this.$el.find(".scrolling-tab-nav").height()) / 2;
        a.documentElement.style.setProperty("--nectar-sticky-tabs-vert-y", t + "px")
    }
    ,
    de.prototype.updateActiveTitle = function() {
    ...
    ,
    de.prototype.domSetup = function() {
        var e = this
          , a = "";
        this.$el.find(".wpb_tab").each(function(n) {
            ...
            e.$el.find(".wpb_tabs_nav li:nth-child(" + (n + 1) + ")").addClass("has-icon").prepend('<a class="skip-hash" href="' + a + '"><i class="' + t(this).attr("data-tab-icon") + '"></i></a>')),
            t(this).find(".im-icon-wrap.tab-icon").length > 0) {
                a = e.$el.find(".wpb_tabs_nav li:nth-child(" + (n + 1) + ") a").attr("href");
                var i = t(this).find(".im-icon-wrap.tab-icon").detach();
                e.$el.find(".wpb_tabs_nav li:nth-child(" + (n + 1) + ")").addClass("has-icon").prepend('<a class="skip-hash svg-icon-link" href="' + a + '"></a>'),
        ...
        this.$el.find(".scrolling-tab-nav .menu-item").each(function(a) {
            ...
            if ("default" == e.linkFunc) {
                var s = t(this).html();
                if (i.prepend('<div class="scrolling-tab-mobile-title"><div class="inner">' + Pt(s) + "</div></div>"),
    ...
    ,
    de.prototype.highlightObserve = function() {
        var n = this;
        if (!(ht.usingMobileBrowser && ht.winW < 1e3) && "IntersectionObserver"in e) {
            ...
            this.observer = new IntersectionObserver(function(e) {
                e.forEach(function(e) {
                    if (!(ht.winW < 1e3)) {
                        ht.scrollTop > n.prevScroll ? n.scrollDir = "down" : n.scrollDir = "up";
    ...
    ,
    de.prototype.getTargetSection = function(t) {
    ...
    ,
    pe.prototype.calcTopOffset = function() {
        this.topOffset = (ht.winH - this.$innerEl.height()) / 2
    }
    ,
    pe.prototype.resizeEvent = function() {
        ht.winW > 1e3 ? (this.calcTopOffset(),
        this.$innerEl.css({
            top: this.topOffset
        })) : this.$innerEl.css({
            top: ""
    ...
    ,
    Ie.prototype.calculatePos = function() {
        1 != pt.materialOffCanvasOpen && 1 != pt.ocmAnimating && (this.offsetTop = this.$element.offset().top,
        this.height = this.$element.outerHeight(),
        this.vertCenter = this.storedWinH / 2 - this.height / 2),
        ht.usingMobileBrowser || (this.storedWinH = ht.winH)
    }
    ,
    Ie.prototype.orientationChange = function() {
        ht.usingMobileBrowser && (this.offsetTop = this.$element.offset().top,
        this.height = this.$element.outerHeight(),
        this.storedWinH = ht.winH)
    }
    ,
    Ie.prototype.trackView = function() {
        var t = this;
        if (this.$element.parents(".top-level").length > 0 && (this.topLevel = !0,
        this.offsetTop > ht.winH && (this.topLevel = !1)),
    ...
    ,
    Ie.prototype.animate = function() {
        if (1 != pt.materialOffCanvasOpen) {
            if (1 == this.lerp ? this.lastY = ht.scrollTop : this.lastY = parseInt(jt(this.lastY, ht.scrollTop, this.lerp)),
            1 == pt.animatedScrolling && (this.inView = !0),
            this.inView) {
                var t = this.intensity;
                ht.winW < 1025 && (t /= 1.2),
                ht.winW < 690 && (t /= 1.35),
                !0 === this.topLevel && ht.winW > 1e3 || !0 === this.topLevel && this.persistOnMobile ? this.$elementInner[0].style.transform = this.type + "(" + -this.lastY * t + "px) translateZ(0)" : ht.winW > 1e3 || this.persistOnMobile ? this.$elementInner[0].style.transform = this.type + "(" + -(this.lastY - this.offsetTop + this.vertCenter) * t + "px) translateZ(0)" : this.$elementInner[0].style.transform = this.type + "(0px) translateZ(0)"
            }
    ...
    Ee.prototype.setup = function() {
        ...
        ht.usingFrontEndEditor && "page-header" != this.type && (this.firstSection = !1),
        ...
        this.nestedParallax || setInterval(function() {
            1 != pt.materialOffCanvasOpen && 1 != pt.ocmAnimating && (a.offsetTop = a.$el.offset().top,
    ...
    ,
    Ee.prototype.checkColumnAnimation = function() {
        this.$parallaxEl.parents(".col.has-animation.triggered-animation:not(.animated-in)").length > 0 && this.realtimeOffsetUpdate()
    }
    ,
    Ee.prototype.realtimeOffsetUpdate = function() {
        var t = this
          , e = setInterval(function() {
            1 != pt.materialOffCanvasOpen && (t.offsetTop = t.$el.offset().top,
    ...
    Ee.prototype.resize = function() {
        ht.usingMobileBrowser ? this.nestedParallax || (this.offsetTop = this.$el.offset().top,
        this.height = this.$el.outerHeight(!0)) : (this.storedWinH = ht.winH,
        this.offsetTop = this.$el.offset().top,
        this.height = this.$el.outerHeight(!0))
    }
    ,
    Ee.prototype.orientationChange = function() {
        ht.usingMobileBrowser && (this.offsetTop = this.$el.offset().top,
        this.height = this.$el.outerHeight(!0),
        this.storedWinH = ht.winH)
    }
    ,
    Ee.prototype.update = function() {
        if (this.offsetTop + 150 + this.height < ht.scrollTop || this.offsetTop - 150 > ht.scrollTop + this.storedWinH || 1 == pt.materialOffCanvasOpen) {
            for (var t = 0; t < this.$parallaxEl.length; t++)
                this.$parallaxEl[t].style.willChange = "auto";
            requestAnimationFrame(this.update.bind(this))
        } else {
            for (t = 0; t < this.$parallaxEl.length; t++)
                !0 === this.firstSection ? this.$parallaxEl[t].style.transform = "translate3d(0, " + parseInt(ht.scrollTop * this.speed) + "px, 0)" : this.$parallaxEl[t].style.transform = "translate3d(0, " + parseInt((this.storedWinH + ht.scrollTop - this.offsetTop) * this.speed) + "px, 0) scale(1.005)",
                this.$parallaxEl[t].style.willChange = "transform";
            requestAnimationFrame(this.update.bind(this))
        }
    }
    ,
    t(e).on("salient-parallax-el-recalculate", Oe),
    ze.prototype.setupProps = function() {
        ...
        (this.$el.is(".top-level") || this.$el.parents(".top-level").length > 0) && (this.topLevel = !0)
    }
    ,
    ze.prototype.lazyInit = function() {
        var t = this;
        if (!ht.usingFrontEndEditor && "IntersectionObserver"in e) {
            t = this;
    ...
    ,
    ze.prototype.setActiveDevice = function() {
        var t = this;
        Object.keys(this.devices).forEach(function(e) {
            ht.winW >= t.devices[e].min && ht.winW <= t.devices[e].max && (t.activeDevice = e,
            void 0 !== t.timelines[e] && t.timelines[e].reset())
        })
    }
    ,
    ze.prototype.createTimeline = function() {
        var t = this;
        Object.keys(this.devices).forEach(function(e) {
    ...
    ,
    ze.prototype.progressValues = function() {
    ...
    ze.prototype.update = function() {
        1 != pt.materialOffCanvasOpen && 1 != pt.ocmAnimating && this.progressValues(),
        requestAnimationFrame(this.update.bind(this))
    }
    ,
    t(e).on("salient-parallax-bg-recalculate", Me),
    Pe.prototype.calculatePos = function() {
        1 != pt.materialOffCanvasOpen && 1 != pt.ocmAnimating && (this.offsetTop = this.$element.offset().top,
        this.height = this.$element.outerHeight(),
        this.vertCenter = ht.winH / 2 - this.height / 2)
    }
    ,
    Pe.prototype.trackView = function() {
        var t = this;
        if (this.$element.parents(".top-level").length > 0 && (this.topLevel = !0),
        "IntersectionObserver"in e) {
            var n = {
    ...
    Pe.prototype.animate = function() {
        if (1 != pt.materialOffCanvasOpen) {
            if (1 == pt.animatedScrolling && (this.inView = !0),
            this.lastY = jt(this.lastY, ht.scrollTop, .2),
            this.inView) {
                var a = this;
                this.$element.find(".bg-layer").each(function(e) {
                    var n = t(this).data("scale");
                    a.layer1Parallax && (e = e / 1.5 + 1),
                    !0 === a.topLevel && ht.winW > 1e3 ? t(this)[0].style.transform = "translateY(" + -a.lastY * a.intensity * e + "px) translateZ(0) scale(" + n + ")" : t(this)[0].style.transform = "translateY(" + -(a.lastY - a.offsetTop + a.vertCenter) * a.intensity * e + "px) translateZ(0) scale(" + n + ")"
                })
            }
            e.requestAnimationFrame(this.animate.bind(this))
        } else
    ...
    ,
    t(e).on("salient-lazyloading-image-reinit", ta),
    t(e).on("salient-lazyloading-image-reinit", ea),
    ia.prototype.initialMarkup = function() {
        ...
        this.el.append('<div class="load-more-wrap inactive"><a href="#" class="load-more">' + this.el.attr("data-load-more-text") + "</a></div>")) : (this.el.removeClass("all-loaded"),
        this.el.append('<div class="load-more-wrap"><a href="#" class="load-more">' + this.el.attr("data-load-more-text") + "</a></div>")))
    }
    ,
    ia.prototype.lightboxGroups = function() {
        var e = Dt()
    ...
    ,
    ia.prototype.externalProjectLinks = function() {
    ...
    ,
    ia.prototype.clickEvents = function() {
        ...
        this.el.find(".nectar-post-grid-filters a, .load-more-wrap .load-more").on("click", function(r) {
            ...
            t.post(e.nectarLove.ajaxurl, f, function(a) {
                if ("load-more" === c)
                    l.append(a);
                else if (l.html(a),
                l.parent().hasClass("nectar-post-grid-wrap--fl-sidebar_left") || l.parent().hasClass("nectar-post-grid-wrap--fl-sidebar_right")) {
                    var n = l.parent().offset().top
                      , r = 0;
                    0 == t(".page-template-template-no-header-footer").length && 0 == t(".page-template-template-no-header").length && 0 == t('body[data-header-format="left-header"]').length && (r = t("#header-outer").height()),
                    ht.winW > 999 && ht.scrollTop > n + 200 && e.scrollTo(0, n - r)
                }
                l.is('[data-animation="fade-in-from-bottom"]') && (o.parents(".nectar-post-grid-wrap").removeClass("finished-animating"),
    ...
    ,
    ia.prototype.deepLinking = function() {
        void 0 !== Kt["grid-filter"] && this.el.find(".nectar-post-grid-filters a").each(function() {
            var e = t(this).clone()
              , a = Kt["grid-filter"];
            t(this);
            (e = (e = e.text()).replace(/\s+/g, "-").toLowerCase()).length > 0 && "-" === e.substring(0, 1) && (e = e.substring(1)),
    ...
    var ja, Ya = function(t) {
        e.console && e.console.error(t)
    };
    function Pa() {
        var e = parseInt(g.height());
    ...
    function Va() {
        ...
        if (t('#page-header-bg[data-parallax="1"]').length > 0) {
            var r = new Image
              ...
              , c = Gt(t('#page-header-bg[data-parallax="1"]').css("background-image"));
            c && -1 !== c.indexOf(".") ? (r.onload = function() {
                Ra()
            }
            ,
            r.src = Gt(t('#page-header-bg[data-parallax="1"]').css("background-image"))) : Ra(),
            ht.winW > 1e3 && p(),
            e.addEventListener("scroll", function() {
                ht.winW > 1e3 && e.requestAnimationFrame(p)
            }, !1)
        }
        ...
        if (g.length > 0) {
            ...
            var u = Gt(g.css("background-image"));
            u && -1 !== u.indexOf(".") && g.addClass("has-bg"),
            s.on("smartresize", Pa)
        }
        function p() {
            ht.winW >= 1e3 && null == navigator.userAgent.match(/iPad/i) && 1 != pt.materialOffCanvasOpen && (1 == a.inView && (n.css({
                transform: "translateY(" + .15 * ht.scrollTop + "px)",
                opacity: 1 - ht.scrollTop / (.7 * (d + o))
            }),
            i && i.css({
                transform: "translateY(" + .15 * ht.scrollTop * 2 + "px)"
            })),
            ht.scrollTop / (o + l + ht.adminBarHeight) > 1 ? (a.inView = !1,
    ...
    function Na() {
        ...
        0 == t("#page-header-bg .nectar-video-wrap video").length && setTimeout(Xa, e)
    }
    function Da() {
    ...
    function Qa() {
        t(".nectar-box-roll").length > 0 && "undefined" != typeof NectarBoxRoll && (Na(),
        ...
        (dt = new NectarBoxRoll(ht,Za,Da,Rn,ya)).inUse = !0)
    }
    function Za() {
        var e, a, i, o, l, c, h, u, p;
        a = 1 == rt ? "500%" : "93%",
        i = 1 == rt ? "500%" : "95%",
        t(st + '.row-bg-wrap[data-bg-animation]:not([data-bg-animation="none"]) .row-bg').each(function() {
        ...
        l = 1 == rt ? "500%" : "93%",
        c = 1 == rt ? "500%" : "80%",
        t(st + '.column-image-bg-wrap[data-bg-animation]:not([data-bg-animation="none"]) .column-image-bg').each(function() {
            var e = t(this).parents(".column-image-bg-wrap").attr("data-bg-animation");
            o = "zoom-out-reveal" != e && -1 == e.indexOf("reveal-from-") ? l : "ro-reveal-from-bottom" == e && 0 == rt ? "95%" : "ro-reveal-from-top" == e && 0 == rt ? "65%" : c;
            var a = t(this)
              , n = new Waypoint({
        ...
        t(st + ".column-bg-overlay-wrap[data-bg-animation]").each(function() {
            o = c;
            var e = t(this)
        ...
        Qe(),
        h = 1 == rt ? "250%" : "75%",
        t(st + '.nectar-icon-list[data-animate="true"]').each(function() {
            var e = t(this)
              , a = new Waypoint({
                element: e[0],
                handler: function() {
        ...
        Ue(),
        u = 1 == rt ? "200%" : "95%",
        t(st + ".clients.fade-in-animation").each(function() {
            var e = t(this)
              , a = new Waypoint({
                element: e[0],
                handler: function() {
        ...
        Re(),
        p = 1 == rt ? "500%" : "bottom-in-view",
        0 == A.length || ht.usingFrontEndEditor && t("#nectar_fullscreen_rows").length > 0 ? (t(".svg-icon-holder:not(.animated-in)").has("svg").each(function(e) {
            var a = t(this);
            z && a.attr("data-animation", "false"),
            a.find("svg").css({
            ...
            a.css("opacity", "1")),
            a.hasClass("bound") || (A[e] = new Vivus(a.find("svg").attr("id"),{
                type: "delayed",
            ...
            function s() {
                ...
                1 == A[e].isReady ? setTimeout(function() {
                    a.css("opacity", "1"),
                    A[e].reset().play()
                }, t) : setTimeout(s, 50)
            }
        ...
        t('.vc_row-o-equal-height .svg-icon-holder[data-animation="true"]').length > 0 && 0 == t("#nectar_fullscreen_rows").length && s.on("smartresize", function() {
            ...
            n = setTimeout(function() {
                A.length > 0 && t(".svg-icon-holder.animated-in").each(function() {
        ...
        t("#nectar_fullscreen_rows .svg-icon-holder.animated-in").has("svg").each(function(e) {
            ...
            A[i].finish()) : t(this).parents(".active").length > 0 || t(this).parents("#footer-outer").length > 0 || t("body.mobile").length > 0 ? (A[i].reset(),
            K[e] = setTimeout(function() {
                A[i].play()
            }, a)) : A[i].reset().stop()
        }),
        function() {
            if (t(".nectar-milestone").each(function() {
                var e;
                t(this).is("[data-symbol]") && (0 == t(this).find(".symbol-wrap").length && ("before" == t(this).attr("data-symbol-pos") ? t(this).find(".number").prepend('<div class="symbol-wrap"><span class="symbol">' + t(this).attr("data-symbol") + "</span></div>") : t(this).find(".number").append('<div class="symbol-wrap"><span class="symbol">' + t(this).attr("data-symbol") + "</span></div>")),
            ...
            !z && t(".nectar-milestone").length > 0 || r.hasClass("rtl") && t(".nectar-milestone").length > 0) {
                var e = "";
                t(st + ".nectar-milestone.motion_blur").each(function(a) {
                    t(this).removeClass(function(t, e) {
                        return (e.match(/(^|\s)instance-\S+/g) || []).join(" ")
                    }),
                    t(this).addClass("instance-" + a);
                    ...
                    0 != ct.$usingFullScreenRows || 0 == t(this).find(".number > span").length) {
        ...
        _e(),
        t(st + '.owl-carousel[data-enable-animation="true"]').each(function() {
            var e = 1 == rt ? "200%" : "bottom-in-view"
              , a = 0;
            t(this).is("[data-animation-delay]") && t(this).attr("data-animation-delay").length > 0 && "false" != t(this).attr("data-animation") && (a = t(this).attr("data-animation-delay"));
            var n = t(this)
              , i = new Waypoint({
        ...
        function() {
            if (t('body[data-header-inherit-rc="true"]').length > 0 && 0 == t(".mobile").length && t('#header-outer[data-transparent-header="true"]').length > 0) {
                var e = b / 2 + w + ht.adminBarHeight;
                0 == t('#header-outer[data-permanent-transparent="1"]').length && (e = b - y + Math.ceil(2 * w / 1.8) + ht.adminBarHeight),
    ...
    function Ga() {
        ...
        r.on("click", ".toggle > h3 a, .toggle > .toggle-title a", function() {
            if (!t(this).parents(".toggles").hasClass("accordion")) {
                ...
                t(this).parents(".toggle").find("> div .iframe-embed").length > 0 && "0" == t(this).parents(".toggle").find("> div iframe.iframe-embed").height() && ba(),
        ...
        r.on("click", ".toggles.accordion .toggle > h3 a, .toggles.accordion .toggle > .toggle-title a", function(a) {
            ...
            if (0 == t(this).parents('.toggle[data-inner-wrap="true"]').length)
                ...
                void 0 !== a.originalEvent && ht.winW < 1e3 && i.find(".toggle.open").length > 0 && 0 == ct.$usingFullScreenRows && (i.find(".toggle.open"),
                setTimeout(function() {
                    var e = r.offset().top - ht.adminBarHeight;
                    t('#header-outer[data-mobile-fixed="1"]').length > 0 && (e = r.offset().top - d.outerHeight() - ht.adminBarHeight),
                    Qt(e, 500, "easeInOutQuint")
                }, 50));
                var o = r.find("> div")[0];
        ...
        0 !== t(".team-member").length && (r.on("click", '.team-member[data-style="bio_fullscreen"], .team-member[data-style="bio_fullscreen_alt"]', function() {
            if (!(t(".nectar_team_member_overlay").length > 0)) {
                var a = t("body > #boxed").length > 0 ? "in-boxed" : ""
                  ...
                  , c = "";
                if (c = t(this).is('[data-style="bio_fullscreen_alt"]') ? '<div class="title">' + Pt(i) + "</div><h2>" + t(this).find(".team-meta h3").text() + "</h2>" : "<h2>" + t(this).find(".team-meta h3").text() + '</h2><div class="title">' + Pt(i) + "</div>",
                r.append('<div class="nectar_team_member_overlay ' + a + '" data-style="' + l + '"><div class="inner-wrap"><div class="team_member_details"><div class="bio-inner"><span class="mobile-close"></span>' + c + '<div class="team-desc">' + Pt(n) + '</div></div></div><div class="team_member_picture"><div class="team_member_image_bg_cover"></div><div class="team_member_picture_wrap"><div class="team_member_image"></div></div></div></div></div>'),
                o.length > 0) {
                    var h = new Image;
                    h.src = o,
                    h.onload = function() {
                ...
                t('.team-member[data-style="bio_fullscreen"]').length > 0 && ht.usingMobileBrowser && t(".nectar_team_member_overlay").addClass("on-mobile"),
                ba(),
        ...
        (t('.team-member[data-style="bio_fullscreen"]').length > 0 || t('.team-member[data-style="bio_fullscreen_alt"]').length > 0) && (s.on("resize", be),
        !ht.usingMobileBrowser)) && new bt("","close-indicator"),
        t(".nectar-flip-box").length > 0 && (ht.usingMobileBrowser && r.on("click", ".nectar-flip-box", function() {
        ...
        Wn(),
        Le(),
        t(".morphing-outline").length > 0 && (setTimeout(ye, 100),
        setTimeout(Be, 125),
        s.on("smartresize", ye)),
        q = [],
        ht.usingMobileBrowser || t("[data-nectar-link-indicator]").each(function(e) {
            q[e] = new bt(t(this),"link-indicator")
        }),
        na(),
        t(".nectar_cascading_images").length > 0 && (P = [],
        t(".nectar_cascading_images").each(function(e) {
            imagesLoaded(t(this), function(a) {
                Ye(),
                t(a.elements[0]).is('[data-parallax="yes"]') && !ht.usingMobileBrowser && 0 == t("#nectar_fullscreen_rows").length && (P[e] = new Pe(t(a.elements[0]),t(a.elements[0]).attr("data-parallax-intensity")))
            })
        }),
        s.on("resize", Ye)),
        Ge(),
                ...
                i.prototype.createWaypoint = function() {
                        ...
                        handler: t.proxy(function(a) {
                            ...
                            i) {
                                ...
                                if (this.topLevel && t('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length > 0) {
                                    var l = d.outerHeight()
                                      , h = 0;
                                    c.length > 0 && (l -= ht.secondaryHeaderHeight),
                                    f.length > 0 && 0 == t("body.mobile").length && (h = ot ? f.height() : 0),
                                    o = l - h
                                }
                    ...
                    setInterval(function() {
                        if (t('body[data-hhun="1"] #header-outer.detached:not(.invisible)').length > 0) {
                            var e = d.outerHeight();
                            c.length > 0 && (e -= ht.secondaryHeaderHeight),
        ...
        D = [],
        "undefined" == typeof NectarLiquid || ht.usingFrontEndEditor || t('.row-bg-wrap[data-bg-animation*="displace-filter"] .row-bg.using-image, .column-image-bg-wrap[data-bg-animation*="displace-filter"] .column-image-bg').each(function(e) {
            var a, n, i = t(this);
    ...
    function tn() {
        ...
        function() {
            if (0 != t("body.woocommerce-account #customer_login").length) {
                t(".woocommerce-account .woocommerce > #customer_login").prepend('<div class="nectar-form-controls" />'),
        ...
        !(t('.products[data-rm-m-hover="1"]').length > 0 && ht.usingMobileBrowser) && (r.on("mouseover", ".text_on_hover .product-wrap, .text_on_hover > a:first-child", function() {
        ...
        function c(e) {
            var a = s.width();
            e.clientX < a - 370 - v && t(".nectar-slide-in-cart").hasClass("mouse-accessed") && (s.off("mousemove.rightCartOffsetCheck", c),
        ...
        !(t('.products[data-rm-m-hover="1"]').length > 0 && ht.usingMobileBrowser) && e.nectarOptions && e.nectarOptions.woo_minimal_product_effect && "default" === e.nectarOptions.woo_minimal_product_effect && (r.on("mouseover", ".products .minimal.product", function() {
            var e, a, n, i, s, r;
            e = t(this),
            n = (a = e).width(),
            i = a.height(),
        ...
        r.on("click", ".nectar-slide-in-cart.style_slide_in_click .close-cart, .nectar-slide-in-cart-bg", en),
        new Ja,
        ...
        if (e.nectarOptions && "1" === e.nectarOptions.woo_product_filter_toggle && r.is(".archive.woocommerce"))
            new Ua;
        t(a).on("yith-wcan-ajax-filtered", ta)
    }
    function en() {
    ...
    function nn() {
        t('#header-outer[data-format="centered-menu-bottom-bar"]').length > 0 && function() {
            var e = d
              ...
              , u = o + h + l + parseInt(ht.secondaryHeaderHeight);
            function p() {
                Zt() ? d.addClass("within-custom-breakpoint") : d.removeClass("within-custom-breakpoint")
            }
            function g() {
                if (!(ht.winW < 1e3 || t("body.page-template-template-no-header").length > 0 || t("body.page-template-template-no-header-footer").length > 0 || t("body.material-ocm-open").length > 0 || "none" == t('#header-outer[data-has-menu="true"][data-format="centered-menu-bottom-bar"] .span_9').css("display") || "none" == t('#header-outer[data-has-menu="true"][data-format="centered-menu-bottom-bar"] .span_9 > nav').css("display")))
                    if (f = f.length > 0 && ht.secondaryHeaderHeight > 0 ? f.height() : 0,
                    e.hasClass("force-condense") || !e.hasClass("fixed-menu") && ht.scrollTop >= u) {
                        var n = parseInt(a.position().top) - o - parseInt(ht.adminBarHeight) + parseInt(ht.secondaryHeaderHeight) - f;
                        ...
                        !e.is('[data-menu-bottom-bar-align="left"]')) {
                            ...
                            r.find(".nectar-woo-cart").css("height", e.height() + parseInt(e.css("top")) - parseInt(ht.adminBarHeight))
                        }
                    } else
                        (e.hasClass("force-condense-remove") || e.hasClass("fixed-menu") && ht.scrollTop < u) && (e.removeClass("fixed-menu").css({
                            top: "0",
                            position: "absolute"
                        }),
                        r.css("transform", "translateY(0px)"),
                        r.find(".nectar-woo-cart").css("height", ""),
            ...
            i.length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length && t('#header-outer[data-condense="true"]').length > 0 && setTimeout(function() {
                "none" != c.css("display") && (ht.secondaryHeaderHeight = c.outerHeight())
            }, 50),
            t('#header-outer[data-condense="true"]').length > 0 && (s.on("scroll.centeredNavCondense", g),
            s.trigger("scroll"),
            s.on("resize", function() {
                (ht.winW < 1e3 || Zt()) && (e.addClass("force-condense-remove"),
                s.off("scroll.centeredNavCondense"))
            }),
            s.on("smartresize", function() {
                p(),
                ht.winW >= 1e3 && 0 == Zt() && e.hasClass("force-condense-remove") && (g(),
                e.removeClass("force-condense-remove"),
                setTimeout(function() {
                    ht.scrollTop >= u && (e.addClass("force-condense"),
                    g(),
    ...
    function sn() {
        if (ht.winW > 1e3) {
            ...
            t('#header-outer[data-format="centered-logo-between-menu"]').length > 0 && ht.winW < 1e3 && t("#header-outer .row > .col.span_9").css({
                "padding-right": "0",
                "padding-left": "0"
            })
    }
    function rn() {
        if (t('#header-outer[data-format="centered-logo-between-menu"]').length > 0) {
            if (C) {
                if (C && t('#header-outer[data-format="centered-logo-between-menu"]').length > 0 && t("header#top #logo img:first[src]").length > 0) {
                    var e = new Image;
    ...
    function on() {
        t("#nectar_fullscreen_rows").length > 0 && 1 == rt && d.attr("data-permanent-transparent", "false"),
        ht.usingMobileBrowser && t('#header-outer[data-mobile-fixed="1"]').length > 0 && 0 == t('#header-outer[data-transparent-header="true"]').length && t("#header-space").css("height", d.outerHeight()),
        e.nectarOptions && e.nectarOptions.header_entrance && "true" == e.nectarOptions.header_entrance && (0 == ht.scrollTop ? t("#header-outer").addClass("entrance-animation") : t("#header-outer").css("opacity", "1")),
        0 == t("#nectar_fullscreen_rows").length && 0 == t(".nectar-box-roll").length ? Da() : t("#nectar_fullscreen_rows").length > 0 && 0 == rt && Da()
    }
    t.fn.dlmenu = function(e) {
        if ("string" == typeof e) {
            ...
            this.each(function() {
                ...
                n ? t.isFunction(n[e]) && "_" !== e.charAt(0) ? n[e].apply(n, a) : Ya("no such method '" + e + "' for menu instance") : Ya("cannot call methods on menu prior to initialization; attempted to call method '" + e + "'")
            })
        } else
            this.each(function() {
    ...
    ,
    Ua.prototype.events = function() {
        this.$toggleBtn.on("click", this.toggle.bind(this)),
        this.$sidebar.find(".nectar-close-btn-wrap").on("click", this.mobileToggle.bind(this)),
        t(e).on("smartresize", this.mobileToggleResize.bind(this))
    }
    ,
    Ua.prototype.mobileToggleResize = function() {
        this.$sidebar.hasClass("open") && ht.winW > 999 && (this.$sidebar.removeClass("open"),
        this.$sidebar.find(".nectar-close-btn-wrap").removeClass("open"),
        t(".container-wrap").css("z-index", "11"))
    }
    ,
    Ua.prototype.mobileToggle = function() {
    ...
    ,
    Ja.prototype.increment = function() {
    ...
    ,
    Ja.prototype.decrement = function() {
        this.state.min && (this.state.min == this.state.currentVal || this.state.currentVal < this.state.min) ? (this.$qty.val(0),
        this.state.removeFlag = !0) : this.state.currentVal > 0 && this.$qty.val(this.state.currentVal - parseFloat(this.step)),
        this.$qty.trigger("change")
    }
    ,
    Ja.prototype.checkMiniCart = function(t) {
        return t.parents(".woocommerce-mini-cart").length > 0
    }
    ,
    Ja.prototype.updateCart = function(n) {
        var i = this;
        clearTimeout(this.ajaxTimeout),
        this.ajaxTimeout = setTimeout(function() {
            i.$qty.closest(".widget_shopping_cart_content").addClass("loading"),
            i.$qty.closest(".woocommerce-mini-cart-item").addClass("blockUI").addClass("blockOverlay"),
            t.ajax({
                type: "POST",
    ...
    ,
    Ka.prototype.addToCartAJAX = function(a) {
        var n = this
    ...
    ,
    an.prototype.keyHandle = function(t) {
        -1 == [16, 91, 32, 37, 39, 17].indexOf(t.keyCode) && (this.throttled(),
        this.debouncedSearch())
    }
    ,
    an.prototype.debouncedSearch = function() {
        var t = this;
    ...
    ,
    an.prototype.resetHeight = function() {
        this.$parent.css({
            "max-height": ""
        }),
        setTimeout(function() {
    ...
    ,
    an.prototype.requestCheck = function() {
        !0 === this.state.requesting && (this.request.abort(),
        this.state.requesting = !1)
    }
    ,
    an.prototype.getResults = function() {
        var a = this
          , n = this.$el.val();
        ...
        this.request = t.ajax({
            ...
            success: function(e) {
                ...
                ht.winW >= 1e3 && !d.hasClass("results-shown") && (a.$container.find(".product, .search-post-item").css({
                    opacity: "0",
    ...
    function dn() {
        var e = 0
          , n = 0 == k && t('#page-header-bg[data-parallax="1"]').length > 0 ? 200 : 60
          , s = 3
          , r = t('.page-submenu[data-sticky="true"]').length > 0;
        ln.bodyOffsetHeight = a.body.offsetHeight,
        0 == ln.init && setInterval(function() {
            1 != pt.materialOffCanvasOpen && (ln.bodyOffsetHeight = a.body.offsetHeight)
        }, 1500),
        ln.raf = requestAnimationFrame(function a() {
            d[0].classList.add("detached");
            var o = ht.scrollTop
              , l = Math.abs(o - e);
            if (1 == pt.animatedScrolling || 1 == pt.preventScroll || 1 == pt.ocmOpen)
                return o > n && (1 == pt.animatedScrolling && 1 == k && 0 == pt.permanentTransHeader && d.removeClass("transparent").addClass("scrolling"),
                e = ht.scrollTop,
                o = ht.scrollTop),
                void (ln.raf = requestAnimationFrame(a));
            if (1 == pt.materialOffCanvasOpen || 1 == pt.materialSearchOpen)
                return 1 == pt.materialSearchOpen && 1 == k && (0 == pt.permanentTransHeader && o > n ? d.removeClass("transparent").addClass("scrolling") : d.addClass("transparent").removeClass("scrolling")),
                void (ln.raf = requestAnimationFrame(a));
            if (!d.hasClass("side-widget-open") && !t("#header-outer .slide-out-widget-area-toggle a").hasClass("animating")) {
                ...
                d.css("transform", "translateY(-" + ht.secondaryHeaderHeight + "px)")) : (c.removeClass("hide-up"),
                d.css("transform", "0px)"))),
                o > n)
                    0 == pt.permanentTransHeader && (0 == ln.timeoutQueued && setTimeout(function() {
                        0 == pt.ocmOpen && (d.removeClass("transparent"),
                    ...
                    ht.winW > 1e3 && t(".sf-menu").length > 0 && t().superfish && (t(".sf-menu").superfish("hide"),
                    ...
                    1 == r && (h = d.outerHeight(),
                    c.length > 0 && (h -= ht.secondaryHeaderHeight),
                    f.length > 0 && ht.winW > 999 ? (i = ot ? f.height() : 0,
            ...
            e = o,
            ln.raf = requestAnimationFrame(a)
        }),
        0 == ln.init && (ln.init = !0)
    }
    function cn() {
        ...
        d.css("transform", "translateY(-" + ht.secondaryHeaderHeight + "px)"))),
        ...
        t("#header-outer:not(.small-nav) header#top nav > ul > li.menu-item-with-margin").stop(!0, !0).animate({
            "margin-right": parseInt(t("header#top nav > ul > li.menu-item-with-margin").css("margin-right")) - 3 * parseInt(y) + "px"
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        ...
        t('#header-outer[data-full-width="true"][data-transparent-header="true"]').length > 0 && f.length > 0 && 1 == ot && t('#header-outer[data-full-width="true"] header > .container').stop(!0, !0).animate({
            padding: "0"
        }, {
            queue: !1,
            duration: 250,
        ...
        t(".nectar-box-roll").length > 0 && 0 == t('#header-outer[data-permanent-transparent="1"]').length && t("#ajax-content-wrap").animate({
            "margin-top": Math.floor(b - y + 2 * w / 1.8 + ht.adminBarHeight + ht.secondaryHeaderHeight)
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        }),
        s.off("scroll.headerResizeEffect", cn),
        s.on("scroll.headerResizeEffect", hn),
    ...
    function hn() {
        ...
        t(".nectar-box-roll").length > 0 && 0 == t('#header-outer[data-permanent-transparent="1"]').length && t("#ajax-content-wrap").animate({
            "margin-top": Math.floor(b + 2 * w + ht.adminBarHeight + ht.secondaryHeaderHeight)
        }, {
            queue: !1,
            duration: 250,
            easing: "easeOutCubic"
        }),
        s.off("scroll.headerResizeEffect", hn),
        s.on("scroll.headerResizeEffect", cn),
        t('#header-outer[data-transparent-header="true"]').css("transition", "transform 0.3s ease, background-color 0.30s ease, opacity 0.3s ease, box-shadow 0.30s ease, margin 0.25s ease-out, backdrop-filter 0.25s ease"),
        t('#header-outer[data-transparent-header="true"] .cart-menu').css("transition", "none"),
        setTimeout(function() {
            t('#header-outer[data-transparent-header="true"]').css("transition", "transform 0.3s ease, background-color 0.30s ease, opacity 0.3s ease, box-shadow 0.30s ease, border-color 0.30s ease, margin 0.25s ease-out, backdrop-filter 0.25s ease"),
    ...
    function un() {
        t('#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && !d.hasClass("within-custom-breakpoint") || ht.scrollTop > 0 && (t("body.material").length > 0 && (d.addClass("scrolled-down"),
        c.length > 0 && ht.winW > 1e3 && (c.addClass("hide-up"),
        d.css("transform", "translateY(-" + ht.secondaryHeaderHeight + "px)"))),
        ...
        s.off("scroll.headerResizeEffectOpaque", un),
        s.on("scroll.headerResizeEffectOpaque", pn))
    }
    function pn() {
        t('#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && !d.hasClass("within-custom-breakpoint") || 0 == ht.scrollTop && 0 == t("body.material-ocm-open").length && (t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0 && t("#header-outer .megamenu").length > 0 ? "true" == d.attr("data-transparent-header") && 0 == t(".megamenu.sfHover:not(.width-75):not(.width-50)").length ? (d.addClass("transparent").removeClass("scrolled-down"),
        ...
        c.length > 0 && ht.winW > 1e3 && (c.removeClass("hide-up"),
        d.removeClass("hide-up").css("transform", "translateY(0%)"))),
        s.off("scroll.headerResizeEffectOpaque", pn),
        s.on("scroll.headerResizeEffectOpaque", un))
    }
    function fn() {
        1 != pt.materialOffCanvasOpen ? (ht.scrollTop > 5 ? "scrolled" != pt.mobileHeader && (0 == pt.permanentTransHeader && d.removeClass("transparent"),
        ht.secondaryHeaderHeight > 0 ? (c.addClass("hide-up"),
        d.css("transform", "translateY(-" + ht.secondaryHeaderHeight + "px)").addClass("hidden-secondary")) : d.removeClass("hidden-secondary"),
        d.addClass("scrolled-down"),
        pt.mobileHeader = "scrolled") : "at-top" != pt.mobileHeader && ("true" == d.attr("data-transparent-header") && d.addClass("transparent"),
        ht.secondaryHeaderHeight > 0 && (c.removeClass("hide-up"),
        d.css("transform", "translateY(0px)")),
        d.removeClass("hidden-secondary").removeClass("scrolled-down"),
        pt.mobileHeader = "at-top"),
        ht.winW < 1e3 && requestAnimationFrame(fn)) : requestAnimationFrame(fn)
    }
    function gn() {
        ht.winW > 999 || (pt.mobileHeader = "",
        s.off("scroll.headerResizeEffect"),
        s.off("scroll.headerResizeEffectOpaque"),
        "1" == T && 0 == t('#header-outer[data-remove-fixed="1"]').length ? t('#header-outer[data-mobile-fixed="1"]').length > 0 ? (t(".nectar-box-roll").length > 0 && d.addClass("at-top-before-box"),
        cancelAnimationFrame(ln.raf),
        dn()) : (cancelAnimationFrame(ln.raf),
        d.removeClass("scrolled-down").removeClass("detached").removeClass("invisible").removeClass("at-top").css("transform", "none")) : t('#header-outer[data-mobile-fixed="1"]').length > 0 ? requestAnimationFrame(fn) : "true" == d.attr("data-transparent-header") && d.addClass("transparent"),
        s.off("smartresize.nectarNavScrollEffects"),
        s.on("smartresize.nectarNavScrollEffects", mn))
    }
    function mn() {
        ht.winW < 1e3 || (1 == x && "1" != T ? (s.off("scroll.headerResizeEffect"),
        0 == t("#nectar_fullscreen_rows").length ? s.on("scroll.headerResizeEffect", cn) : t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 && ht.usingMobileBrowser && s.on("scroll.headerResizeEffect", cn)) : "1" != T ? (s.off("scroll.headerResizeEffectOpaque"),
        s.on("scroll.headerResizeEffectOpaque", un)) : "1" == T && (t(".nectar-box-roll").length > 0 && d.addClass("at-top-before-box"),
        0 == t('#header-outer[data-remove-fixed="1"]').length && (cancelAnimationFrame(ln.raf),
        dn())),
        t('#header-outer[data-format="centered-menu-bottom-bar"][data-condense="true"]').length > 0 && (c.length > 0 && d.css("transform", ""),
        ht.scrollTop > 200 && !d.hasClass("fixed-menu") && d.addClass("fixed-menu")),
        s.off("smartresize.nectarNavScrollEffects"),
        s.on("smartresize.nectarNavScrollEffects", gn))
    }
    function vn() {
        if (t(".mobile").length > 0)
            ht.winH < ht.winW && ht.winW > 1e3 ? 0 == t("#header-outer.small-nav").length && t("#header-space").css("height", d.outerHeight()) : t("#header-space").css("height", d.outerHeight());
        else if (0 == t(".nectar-parallax-scene.first-section").length) {
            var e = w - w / 1.8
              , a = t('#header-outer[data-header-resize="1"]').length > 0 && t(".small-nav").length > 0 ? d.outerHeight() + (parseInt(y) + 2 * e) : d.outerHeight();
            Math.abs(a - t("#header-space").height()) > 7 && t("#header-space").css("height", a)
        }
    }
    function bn() {
        var e = -1
        ...
        function i() {
            var e = 0;
            if (ht.winW < 1e3 || 1 == _ && "none" == t("#header-outer .span_9").css("display") || 1 == _ && "none" == t("#header-outer .span_9 > nav").css("display")) {
                e = 0;
                var n = "fixed" == u.css("position") ? u.height() : 0;
                (e += ht.adminBarHeight) - a > n ? d.css("top", e - a + "px") : d.css("top", n)
            } else
                0 == _ && (e = 0,
                d.is('[data-remove-fixed="1"]') || (e += ht.adminBarHeight),
                d.css("top", e + "px"))
        }
        t('#header-outer[data-mobile-fixed="1"]').length > 0 && u.length > 0 && (0 == t("#nectar_fullscreen_rows").length ? requestAnimationFrame(n) : t("#nectar_fullscreen_rows").length > 0 && ht.usingMobileBrowser && requestAnimationFrame(n),
        s.on("smartresize", i))
    }
    function wn() {
        var e = 0
          , a = 0;
        if (d.is("[data-logo-height]") && d.is("[data-padding]") ? d.hasClass("transparent") || (e = d.find("#logo.no-image").length > 0 ? "left-header" == $ && ht.winW > 1e3 ? 0 : parseInt(d.find("#logo.no-image").height()) + parseInt(2 * d.attr("data-padding")) : "left-header" == $ && ht.winW > 1e3 ? 0 : parseInt(d.attr("data-logo-height")) + parseInt(2 * d.attr("data-padding"))) : e = "left-header" == $ && ht.winW > 1e3 ? 0 : d.outerHeight(),
        g.length > 0 && (a += g.height()),
        t(".page-header-no-bg").length > 0 && (a += t(".page-header-no-bg").height()),
        ht.winH - ht.adminBarHeight - e - ht.footerOuterHeight - 1 - a > 0) {
            ...
            t('body[data-footer-reveal="1"]:not(.nectar_using_pfsr) .container-wrap').css({
                "margin-bottom": ht.footerOuterHeight
            }),
            t(".container-wrap").css({
                "min-height": ht.winH - ht.adminBarHeight - e - ht.footerOuterHeight - a + n
            })
        } else
            t('body[data-footer-reveal="1"]:not(.nectar_using_pfsr) .container-wrap').css({
                "margin-bottom": ht.footerOuterHeight
            });
        ht.winW < 1e3 ? m.attr("data-midnight", "light") : m.removeAttr("data-midnight")
    }
    function yn() {
        (t('body[data-footer-reveal="1"]').length > 0 || t('body.material[data-slide-out-widget-area-style="slide-out-from-right"]').length > 0) && (setTimeout(wn, 60),
        wn(),
        s.on("resize", wn),
    ...
    function xn() {
        ...
        (a > 0 || navigator.userAgent.match(/Trident.*rv\:11\./)) && (kn(),
        t(e).on("resize", kn))
    }
    function kn() {
    ...
    function $n() {
        t(".nectar-recent-posts-slider").each(function() {
            ...
            if (ht.winW > 1e3 && 0 == t("#boxed").length)
                0 == t(this).parents(".full-width-content").length ? t('body[data-ext-responsive="true"]').length > 0 && ht.winW >= 1400 ? n.css("height", Math.ceil(e)) : 0 == t('body[data-ext-responsive="true"]').length && ht.winW >= 1100 ? n.css("height", Math.ceil(e)) : n.css("height", Math.ceil(e * a)) : n.css("height", Math.ceil(e * a));
            else {
    ...
    function In() {
        (t('.nectar-split-heading[data-animation-type="line-reveal-by-space"]').length > 0 || t('.nectar-split-heading[data-animation-type="letter-fade-reveal"]').length > 0) && (t('.nectar-split-heading[data-animation-type="line-reveal-by-space"]:not([data-text-effect="none"])').each(function() {
            var e = t(this).hasClass("animated-in") ? " animated" : "";
            t(this).find("> *").each(function() {
                var a = t(this).text();
                a = (a = a.trim()).split(" "),
                t(this)[0].innerHTML = "";
                for (var n = 0; n < a.length; n++)
                    t(this)[0].innerHTML += '<span><span class="inner' + e + '">' + a[n] + "</span></span> "
            }),
        ...
        t('.nectar-split-heading[data-animation-type="line-reveal-by-space"][data-text-effect*="letter-reveal"]').each(function() {
            if (t(this).is('[data-m-rm-animation="true"]') && ht.winW < 1e3)
                return !0;
    ...
    function En() {
        if (t(".nectar-recent-posts-slider-inner").length > 0) {
            ...
            $n(),
            s.on("resize", $n),
            ht.usingMobileBrowser || ht.usingFrontEndEditor || s.on("resize", zn)
        }
    ...
    function Hn() {
        ...
        ht.usingMobileBrowser || t(".nectar-recent-posts-slider").length > 0 && !ht.usingFrontEndEditor && e.requestAnimationFrame(On),
        ht.usingMobileBrowser || ht.usingFrontEndEditor || zn()
    }
    function Sn() {
        ...
        function $(e, a, n, i, s, r, o, l, d, c) {
            ...
            f = "-2") : (h = .045,
            u = .075);
            var m, v = ht.scrollTop, b = a ? e.touches[0].pageX : e.pageX, w = a ? e.touches[0].pageY : e.pageY, y = n.getBoundingClientRect(), _ = n.clientWidth || n.offsetWidth || n.scrollWidth, C = n.clientHeight || n.offsetHeight || n.scrollHeight, x = 320 / _, k = .52 - (b - y.left - 0) / _, $ = .52 - (w - y.top - v) / C, T = w - y.top - v - C / 2, E = h * x * (k - (b - y.left - 0 - _ / 2)), O = u * x * (T - $);
    ...
    function Wn() {
        ...
        t(".nectar_video_player_self_hosted").each(function(e) {
            !ht.usingMobileBrowser && t(this).find(".play_button.follow_mouse").length > 0 && (L[e] = new Mn(t(this),".play_button.follow_mouse .play"))
        }),
        "IntersectionObserver"in e) {
        ...
        t(".nectar-video-box").each(function(e) {
            if (t(this).find(".play_button_mouse_follow").length > 0) {
                ...
                t(this).imagesLoaded(function() {
                    ht.usingMobileBrowser || (L[e] = new Mn(a,".play_button_mouse_follow"));
    ...
    function Fn() {
        ...
        "undefined" != typeof SalientRecentProjectsFullScreen && t(".nectar_fullscreen_zoom_recent_projects").each(function(e) {
            X[e] = new SalientRecentProjectsFullScreen(t(this))
        })
    }
    function qn() {
        ...
        t(".post-area.infinite_scroll .posts-container").infinitescroll({
            ...
            t(e).find("[data-nectar-img-src]").length > 0 && ta(),
            t(".masonry.classic").length > 0 || t(".post-area:not(.masonry):not(.featured_img_left)").length > 0 || t(".post-area.standard-minimal").length > 0 ? (vt(),
            t().mediaelementplayer && t(e).find(".wp-audio-shortcode, .wp-video-shortcode").mediaelementplayer(),
            ne(),
            t(".carousel").length > 0 && (Ot(),
            Wt()),
            Za(),
    ...
    function Ln() {
        ht.scrollTop > 350 && !o.is(".fullscreen.open") && (t("#to-top").stop().transition({
    ...
    function jn() {
        if (ht.scrollTop < 350 || o.is(".fullscreen.open")) {
    ...
    function Yn() {
        if (0 == t(".nectar-social.fixed").length && (t("#to-top").length > 0 && s.width() > 1020 || t("#to-top").length > 0 && t("#to-top.mobile-enabled").length > 0) && (ht.scrollTop > 350 ? s.on("scroll", jn) : s.on("scroll", Ln)),
    ...
    function Pn() {
        ...
        0 == t("#nectar_fullscreen_rows").length || 0 == ct.$usingFullScreenRows ? t("a.nectar-next-section").each(function() {
    ...
    function Rn() {
        ...
        a && t(".main-content").find(a).length > 0 || a && t(".main-content").find('[data-fullscreen-anchor-id="' + n + '"]').length > 0) {
            ...
            var u = 100;
            t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (dt.boxRoll(null, -1),
            u = 2050),
            t("img[data-nectar-img-src]").length > 0 && (Je(),
            u = 200),
            setTimeout(function() {
                var e;
                if (0 == t('body[data-permanent-transparent="1"]').length)
                    if (r.hasClass("mobile"))
                        e = t('#header-outer[data-mobile-fixed="1"]').length > 0 ? l.offset().top + 2 - h + ht.adminBarHeight : l.offset().top - ht.adminBarHeight + 1;
                    else {
                        var a = t('#header-outer[data-header-resize="0"]').length > 0 ? 0 : parseInt(y) + 2 * i;
                        if (t('#header-outer[data-remove-fixed="1"]').length > 0 && (h = 0),
                        e = l.offset().top - parseInt(h) + a + 3 - ht.adminBarHeight,
                        0 == t("body.mobile").length && t('#header-outer[data-condense="true"]').length > 0 && 0 === t("body.page-template-template-no-header").length && 0 === t("body.page-template-template-no-header-footer").length) {
                            var n = t('#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_9')
                              , s = d.height() - (parseInt(n.height()) + parseInt(t("#header-outer #logo").css("margin-top")));
                            e = l.offset().top - parseInt(h) + s - ht.adminBarHeight
                        }
                    }
                else
                    e = l.offset().top - ht.adminBarHeight + 1;
                t('body[data-hhun="1"]').length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length && 0 == t("#header-outer.detached").length && (e += h),
                Qt(e - (t('.page-submenu[data-sticky="true"]').length > 0 ? t(".page-submenu").height() : 0) + (t("body.material").length > 0 && c.length > 0 && 0 == t('body[data-hhun="1"]').length && 0 == t('#header-outer[data-remove-fixed="1"]').length && !r.hasClass("mobile") ? c.height() : 0), 700, "easeInOutQuint"),
                pt.animatedScrolling = !0,
                setTimeout(function() {
                    pt.animatedScrolling = !1
                }, 1100)
            }, u)
        }
    }
    function Vn() {
        ...
        t(".portfolio-items:not(.carousel)").each(function(a) {
            ...
            "undefined" != typeof SalientPortfolio)
                S[e] = new SalientPortfolio(t(this),Be,st,$e),
                e++;
            else {
                var n = t(this);
                Vt("#salient-portfolio-js-js", 100, function() {
                    S[e] = new SalientPortfolio(n,Be,st,$e),
                    e++
                })
            }
        })
    ...
    function Xn() {
        ht.winW > 690 && t('.posts-container[data-load-animation="perspective"]').css("perspective-origin", "50% " + (ht.scrollTop + ht.winH) + "px"),
        requestAnimationFrame(Xn)
    }
    function Nn() {
        t('.posts-container[data-load-animation="perspective"]').length > 0 && requestAnimationFrame(Xn)
    }
    function Dn(e) {
        ...
        t(".posts-container").each(function(e) {
            if (t(this).parent().hasClass("masonry") && !t(this).parent().hasClass("auto_meta_overlaid_spaced")) {
                if ("undefined" == typeof NectarMasonryBlog) {
                    var a = t(this);
                    return void Vt("#nectar-masonry-blog-js", 0, function() {
                        G[e] = new NectarMasonryBlog(a,$e,Dn)
                    })
                }
                G[e] = new NectarMasonryBlog(t(this),$e,Dn)
            } else
                Dn(t(this))
        })
    }
    function Zn() {
        ...
        if (t('#header-outer[data-remove-fixed="0"]').length > 0 && 0 == t('#header-outer[data-format="left-header"]').length) {
            ...
            if (0 == t("body.mobile").length && t('#header-outer[data-condense="true"]').length > 0) {
                var n = t('#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_9');
                e = 50,
                e += d.height() - (parseInt(n.position().top) - parseInt(t("#header-outer #logo").css("margin-top"))) - parseInt(ht.secondaryHeaderHeight)
            }
        }
    ...
    function Gn() {
        var n = Zn();
        if (ht.winW < 690 && ht.usingMobileBrowser || a.documentElement.style.setProperty("--nectar-sticky-top-distance", n + "px"),
        t(".nectar-sticky-column-css").each(function() {
            0 == t(this).find(".n-sticky").length && (t(this).wrapInner('<div class="n-sticky" />'),
            t(this).hasClass("nectar-sticky-column-css--middle") && new pe(t(this)))
        }),
        t().theiaStickySidebar && !(ht.usingMobileBrowser && ht.winW < 1e3) && !(0 != ct.$usingFullScreenRows && ht.winW > 1e3)) {
    ...
    function Un() {
        ...
        for (var e = 0; e < D.length; e++)
            "displace-filter-fade" == D[e].animationType && t(D[e].canvasContainer).parents(".fp-section.active").length > 0 && (0 == t(D[e].canvasContainer).find(".image-added-to-stage").length && D[e].imgContainer.addChild(D[e].bg),
            t(D[e].canvasContainer).find(".nectar-liquid-bg").addClass("image-added-to-stage"),
            D[e].animateProps(D[e]))
    }
    function Jn() {
        if (t("#nectar_fullscreen_rows").length > 0 && t().fullpage) {
            st = e.vc_iframe ? ".vc_element.vc_vc_row.active " : ".wpb_row.active ";
            var a = t("#nectar_fullscreen_rows[data-mobile-disable]").length > 0 ? t("#nectar_fullscreen_rows").attr("data-mobile-disable") : "off";
            ht.usingMobileBrowser || (a = "off"),
            "on" != a ? rt = !0 : st = "",
            "undefined" != typeof NectarFullScreenRows && (ct = new NectarFullScreenRows(Za,Z,Un,ht,Ze,U,A,J))
        } else
            Vt("#nectar-fullpage-js", 100, Jn)
    }
    function Kn() {
        ...
        ht.usingMobileBrowser && r.addClass("using-mobile-browser"),
    ...
    function ei() {
        var a = ht.winW
          , n = ht.winH
          , i = 0;
        r.is('[data-flex-cols="true"]') || t('[class*="vc_col-xs-"], [class*="vc_col-md-"], [class*="vc_col-lg-"]').length > 0 && (ti(),
        ht.usingMobileBrowser ? (e.addEventListener("orientationchange", function() {
            i = 1
        }),
        s.on("resize", function() {
            (s.width() != a && s.height != n || 1 === i) && (ti(),
            a = ht.winW,
            n = ht.winH,
            i = 0)
        })) : s.on("resize", ti))
    ...
    function ni() {
        (-1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") || navigator.userAgent.match(/(iPod|iPhone|iPad)/)) && (e.onpageshow = function(e) {
            ...
            }, 100)) : t("#slide-out-widget-area.slide-out-from-right-hover.open").length > 0 && navigator.userAgent.match(/(iPod|iPhone|iPad)/) ? Sa() : (t("#slide-out-widget-area.fullscreen.open").length > 0 || t("#slide-out-widget-area.fullscreen-alt.open").length > 0 || t("#slide-out-widget-area.slide-out-from-right.open").length > 0) && (t("#slide-out-widget-area .slide_out_area_close").addClass("non-human-allowed"),
        ...
        s.on("vc_reload", function() {
            ...
            W.length > 0)
                for (var a = 0; a < W.length; a++)
                    W[a].instance.reloadCells(),
                    W[a].instance.off("scroll.flickity"),
                    W[a].instance.off("dragStart.flickity"),
                    W[a].instance.off("dragEnd.flickity");
            if (yt(),
            setTimeout(function() {
                if (_t(),
                W.length > 0)
                    for (var t = 0; t < W.length; t++)
                        W[t].instance.reloadCells(),
                        W[t].instance.resize()
            }, 100),
            N.length > 0)
                for (a = 0; a < N.length; a++)
                    N[a].instance.flickity("reloadCells"),
                    N[a].instance.off("scroll.flickity"),
                    N[a].instance.off("dragStart.flickity"),
                    N[a].instance.off("dragEnd.flickity");
            setTimeout(function() {
                if (t(".nectar-woo-flickity").length > 0 && At(),
                N.length > 0)
                    for (var e = 0; e < N.length; e++)
                        N[e].instance.flickity("reloadCells"),
                        N[e].instance.flickity("resize")
            }, 100),
            ca();
            for (a = 0; a < Q.length; a++)
                "multiple_visible" != Q[a].type && "multiple_visible_minimal" != Q[a].type || (Q[a].flickityEl.flickity("reloadCells"),
                Q[a].flickityEl.off("select.flickity"),
                ca(),
                Q[a].flickityEl.resize()),
                Q[a].testimonialSliderHeight();
            if (ha(),
            da(),
            ga(),
            ne(),
            ...
            S.length > 0)
                for (a = 0; a < S.length; a++)
                    S[a].portfolioAccentColor();
            if (Sn(),
            Fn(),
            setTimeout(function() {
                if (t(".nectar_fullscreen_zoom_recent_projects").length > 0 && X.length > 0)
    ...
    function oi() {
        var a = !1;
        if (t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-disable-mobile="1"]').length > 0 && ht.winW < 1e3 && (a = !0),
        t('body[data-ajax-transitions="true"]').length > 0 && t('#ajax-loading-screen[data-method="standard"]').length > 0 && 0 == a) {
            ...
            0 != t(".nectar-box-roll").length || ht.usingFrontEndEditor || Za()
    }
    function li(n) {
        var i, l, u, p, g;
        ht.usingMobileBrowser && ht.scrollPosRAF(),
        ea(),
        function() {
            var n;
            if (Et(),
            0 != t('body[data-header-format="left-header"]').length || ht.usingPhoneBrowser || (n = !(t('#header-outer[data-megamenu-rt="1"]').length > 0 && t('#header-outer[data-transparent-header="true"]').length > 0),
            ...
            t('body[data-megamenu-width="full-width"]').length > 0 && t("ul.sub-menu").length > 0 && (It(),
            s.on("smartresize", It),
        ...
        function() {
            e.nectarOptions && e.nectarOptions.quick_search && "true" === e.nectarOptions.quick_search && new an;
        ...
        0 == t('#header-outer[data-remove-fixed="1"]').length && ht.winW > 1e3 && 0 != t(e).scrollTop() && 1 == t('#header-outer.transparent[data-permanent-transparent="false"]').length && d.removeClass("transparent"),
        ht.winW < 1e3 && 0 == t(".nectar-box-roll").length ? (gn(),
        s.on("smartresize.nectarNavScrollEffects", gn)) : (mn(),
        s.on("smartresize.nectarNavScrollEffects", mn)),
        Gn(),
        ha(),
        we(),
        ...
        r.on("click", ".section-down-arrow, .scroll-down-wrap > .minimal-arrow", function() {
            ...
            0 == t('body[data-permanent-transparent="1"]').length)
                if (r.hasClass("mobile"))
                    Qt((t('#header-outer[data-mobile-fixed="1"]').length > 0 ? parseInt(a) - o + parseInt(e.offset().top) + 2 : parseInt(a) + parseInt(e.offset().top) + 2) - 2 * i, 700, "easeInOutQuint");
                else if (t('body[data-hhun="1"]').length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length)
                    Qt(parseInt(a) + n + 2 - 2 * i, 700, "easeInOutQuint");
                else {
                    var h = t('#header-outer[data-header-resize="0"]').length > 0 ? 0 : parseInt(y) + 2 * g;
                    ...
                    0 == t("body.mobile").length && t('#header-outer[data-condense="true"]').length > 0) {
                        ...
                        o = d.height() - (parseInt(u.position().top) - parseInt(t("#header-outer #logo").css("margin-top"))) - parseInt(ht.secondaryHeaderHeight)
                    }
                    Qt(parseInt(a - o) + h + 3 + n + l, 700, "easeInOutQuint")
                }
            else
                Qt(parseInt(a) + parseInt(e.offset().top) + 2 - 2 * i, 700, "easeInOutQuint");
            return !1
        }),
        function() {
            if (O && r.on("click", '#header-outer nav .sf-menu li:not(.slide-out-widget-area-toggle) a[href*="#"]', function() {
                pt.ocmOpen && "#" != t(this).attr("href") && La(t(this).parent())
            }),
            t('body[data-animated-anchors="true"]').length > 0 || t('.single-product [data-gallery-style="left_thumb_sticky"]').length > 0) {
                ...
                r.on("click", "#header-outer nav .sf-menu a, #footer-outer .nectar-button, #footer-outer .widget_nav_menu a, #footer-widgets .textwidget a, #mobile-menu li a, .nectar-scrolling-tabs:not(.navigation_func_active_link_only) .scrolling-tab-nav a, .container-wrap a:not(.wpb_tabs_nav a):not(.navigation_func_active_link_only .scrolling-tab-nav a):not(.comment-wrap .navigation a):not(.woocommerce-checkout a):not(.um-woo-view-order):not(.magnific):not([data-fancybox]):not(.woocommerce-tabs .tabs a):not(.slider-prev):not(.slider-next):not(.testimonial-next-prev a):not(.page-numbers), .swiper-slide .button a, #slide-out-widget-area a, #slide-out-widget-area .inner div a", function(i) {
                    ...
                    0 != ct.$usingFullScreenRows && t('#nectar_fullscreen_rows[data-anchors="on"]').length > 0 && l && "" != l && "#top" != l && t('body.material[data-slide-out-widget-area-style="slide-out-from-right"].material-ocm-open').length > 0 && (i.preventDefault(),
                    ...
                    l && r.find(l).length > 0 && "#top" != l && "" != l && -1 !== t(this).attr("href").indexOf(e.location.href.split("#")[0]) || t(this).is('[href^="#"]') && "" != l && r.find(l).length > 0 && "#top" != l) {
                        ...
                        var p = t(this).parents("#mobile-menu").length > 0 ? t(this).parents("#mobile-menu").height() : null
                          , f = 1
                          , g = t(this);
                        t(".nectar-box-roll").length > 0 && t(".container-wrap.bottomBoxOut").length > 0 && (dt.boxRoll(null, -1),
                        f = 2050),
                        ...
                        setTimeout(function() {
                            ...
                            if (0 == t('body[data-permanent-transparent="1"]').length)
                                if (r.hasClass("mobile"))
                                    e = t('#header-outer[data-mobile-fixed="1"]').length > 0 ? t(l).offset().top + 2 - h + ht.adminBarHeight : t(l).offset().top - p - ht.adminBarHeight + 1;
                                else {
                                    var a = t('#header-outer[data-header-resize="0"]').length > 0 ? 0 : parseInt(y) + 2 * n;
                                    if (t('#header-outer[data-remove-fixed="1"]').length > 0 && (h = 0),
                                    e = t(l).offset().top - p - parseInt(h) + a + 3 - ht.adminBarHeight,
                                    0 == t("body.mobile").length && 0 === t("body.page-template-template-no-header").length && 0 === t("body.page-template-template-no-header-footer").length && t('#header-outer[data-condense="true"]').length > 0) {
                                        var i = t('#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_9')
                                          , s = d.height() - (parseInt(i.height()) + parseInt(t("#header-outer #logo").css("margin-top")));
                                        e = t(l).offset().top - parseInt(h) + s - ht.adminBarHeight
                                    }
                                }
                            else
                                e = t(l).offset().top - ht.adminBarHeight + 1;
                            t('body[data-hhun="1"]').length > 0 && 0 == t('#header-outer[data-remove-fixed="1"]').length && ((0 == t("#header-outer.detached").length || g.parents('.page-submenu[data-sticky="true"]').length > 0) && (e += h),
                            g.parents('.page-submenu[data-sticky="true"]').length > 0 && (t("#header-outer.detached").addClass("invisible"),
                            t(".page-submenu").addClass("header-not-visible").css("transform", "translateY(0px)")));
                            var u, f = g.parents('.page-submenu[data-sticky="true"]').length > 0 ? g.parents(".page-submenu").height() : 0;
                            u = t("body.material").length > 0 && c.length > 0 && 0 == t('body[data-hhun="1"]').length && 0 == t('#header-outer[data-remove-fixed="1"]').length && !r.hasClass("mobile") ? c.height() : t('body[data-hhun="1"]').length > 0 && c.length > 0 && !r.hasClass("mobile") && 0 == t('#header-outer[data-remove-fixed="1"]').length ? c.height() : 0,
                            o && Qt(e - f + u, 700, "easeInOutQuint")
                        }, f),
                        i.preventDefault()
                    }
    ...
    function di() {
        0 == t(e).scrollTop() && vn(),
        t("video").css("visibility", "visible"),
        t('body[data-animated-anchors="true"]').length > 0 && (0 == t(".nectar-box-roll").length && 0 == t("#nectar_fullscreen_rows").length && (void 0 !== Kt.tab ? setTimeout(function() {
            Rn()
        }, 800) : Rn()),
        t('#nectar_fullscreen_rows[data-mobile-disable="on"]').length > 0 && 0 == t(".nectar-box-roll").length && ht.usingMobileBrowser && Rn()),
        Be(),
        ht.usingMobileBrowser || Me(),
        ya()
    }
    _n.prototype.events = function() {
        var a = this;
    ...
    _n.prototype.calculate = function() {
        if (1 == pt.materialOffCanvasOpen)
            return !0;
        this.offsetTop = this.$el.offset().top,
        this.offsetTop < this.storedWinH && this.$el.hasClass("top-level") && !ht.usingFrontEndEditor || (this.$el.css("min-height", this.storedWinH),
        this.$el.find("> .col.span_12").css("min-height", this.storedWinH))
    }
    ,
    _n.prototype.orientationChange = function() {
        ht.usingMobileBrowser && (this.storedWinH = ht.winH,
        this.calculate())
    }
    ,
    Mn.prototype.resizeEvent = function() {
        this.initialX = this.$el.width() / 2,
        this.initialY = this.$el.height() / 2
    }
    ,
    Mn.prototype.mouseEvents = function() {
        var a = this;
        ...
        t(e).on("scroll", function() {
            1 == a.activeFollow && 0 == a.lastScroll && (a.lastScroll = ht.scrollTop)
        })
    }
    ,
    Mn.prototype.rafLoop = function() {
        1 == this.activeFollow ? (this.scrollAdjust = 0,
        this.alteredY = this.elY,
        this.lastScroll > 0 && (this.scrollAdjust = ht.scrollTop - this.lastScroll,
        this.alteredY += this.scrollAdjust),
        this.lastY = jt(this.lastY, this.alteredY, this.percentage),
        this.lastX = jt(this.lastX, this.elX, this.percentage),
        this.lastY2 = jt(this.lastY2, this.alteredY, this.percentage),
        this.innerLastX = jt(this.innerLastX, parseInt(this.elX) - parseInt(this.lastX), this.percentage) / 1.7,
        this.innerLastY = jt(this.innerLastY, parseInt(this.alteredY) - parseInt(this.lastY2), this.percentage) / 1.7) : (this.lastY = jt(this.lastY, this.initialY, .055),
        this.lastX = jt(this.lastX, this.initialX, .055),
        this.innerLastX = 0,
        this.innerLastY = 0),
        this.$iconEl[0].style.transform = "translateX(" + this.lastX + "px) translateY(" + this.lastY + "px)",
        this.$innerIconEl.length > 0 && (this.$innerIconEl[0].style.transform = "translateX(" + Lt(this.innerLastX, 14, -14) + "px) translateY(" + Lt(this.innerLastY, 14, -14) + "px)"),
        requestAnimationFrame(this.rafLoop.bind(this))
    }
    ,
    jQuery(a).ready(function(t) {
        ht.usingFrontEndEditor = void 0 !== e.vc_iframe,
        Qa(),
        Jn(),
        ta(),
        nn(),
        ...
        ai(),
        Nn();
        !e.nectarOptions || !e.nectarOptions.delay_js || e.nectarOptions.delay_js;
        li(),
        new Xt,
        Kn(),
        ni(),
        ...
        s.on("smartresize.srInit", ft),
        s.off("resize.srInit"),
        s.on("resize.srInit", mt),
        e.addEventListener("orientationchange", gt),
        "complete" === a.readyState && di(),
        s.on("load", di)
    })

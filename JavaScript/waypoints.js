    ...
    r.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var a in this.waypoints[r]) {
                var l, h, p, c, u = this.waypoints[r][a], d = u.options.offset, f = u.triggerPoint, w = 0, y = null == f;
                u.element !== u.element.window && (w = u.adapter.offset()[s.offsetProp]),
                "function" == typeof d ? d = d.apply(u) : "string" == typeof d && (d = parseFloat(d),
                ...
                c = !h && !p,
                !y && (h && p) ? (u.queueTrigger(s.backward),
                n[u.group.id] = u.group) : !y && c ? (u.queueTrigger(s.forward),
                n[u.group.id] = u.group) : y && s.oldScroll >= u.triggerPoint && (u.queueTrigger(s.forward),
